"""Run hftbacktest on the Binance BBO alignment demo.

This script runs only the hftbacktest side of the Binance BBO alignment demo
...
def main() -> int:
    """Run hftbacktest strategy on Binance BBO demo data.
