...
RUNTIME_SOURCE_MODULES = (
    ...
    ("backtrader._cerebro", "backtrader._cerebro", "backtrader"),
    ("backtrader._cerebro.registry", "backtrader._cerebro.registry", "backtrader"),
    ("backtrader._cerebro.notifications", "backtrader._cerebro.notifications", "backtrader"),
    ("backtrader._cerebro.lifecycle", "backtrader._cerebro.lifecycle", "backtrader"),
    ("backtrader._cerebro.channel", "backtrader._cerebro.channel", "backtrader"),
    ("backtrader._cerebro.execution", "backtrader._cerebro.execution", "backtrader"),
    ("backtrader._cerebro.runnext", "backtrader._cerebro.runnext", "backtrader"),
    ("backtrader._cerebro.runonce", "backtrader._cerebro.runonce", "backtrader"),
    ("backtrader._cerebro.presentation", "backtrader._cerebro.presentation", "backtrader"),
