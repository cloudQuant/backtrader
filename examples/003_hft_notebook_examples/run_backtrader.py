"""Run backtrader on migrated hftbacktest notebook strategies.

This script runs the backtrader side of the migrated hftbacktest
...
def main() -> int:
    """Run backtrader strategy on prepared Binance BBO data.
