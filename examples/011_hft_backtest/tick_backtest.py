...
Usage:
    ...
    # Then run:
    python examples/011_hft_backtest/tick_backtest.py
"""
...
def main():
    ...
    """
    symbol = "BTC/USDT"
    data_file = PROJECT_ROOT / "tests" / "datas" / "tick_data" / f'tick_{symbol.replace("/", "_")}.csv'
    ...
    channel = TickChannel(symbol=symbol, dataname=str(data_file))
