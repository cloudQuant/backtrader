...
Usage:
    python examples/009_trade_logger/trade_logger_example.py
"""
...
def run_example():
    ...
    # Use the repository's bundled bond-data fixture.
    data_file = os.path.join(PROJECT_ROOT, "tests", "datas", "113013.csv")
