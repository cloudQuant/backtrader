...
# rb (SHFE) quarterlies: dominant and next-dominant calendar legs.
PRODUCT_CALENDARS = {"rb": (1, 5, 10)}
...
def resolve_symbols(today=None):
    """Dominant and next-dominant rebar quarterlies (calendar spread legs)."""
    today = today or dt.date.today()
    return dominant_contracts("rb", today, count=2)
...
def run_replay(scenario="profitable"):
    ...
    with tempfile.TemporaryDirectory(prefix="bt-013-2-replay-") as report_directory:
