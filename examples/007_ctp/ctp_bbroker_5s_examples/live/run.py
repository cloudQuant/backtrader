"""CTP BackBroker 5-second bar live trading runner with SimNow.
...
def _build_parser():
    parser = argparse.ArgumentParser(description='Run BackBroker 5s live examples')
...
def main():
    ...
    print(f'Running BackBroker 5s live example with {config_path}')
