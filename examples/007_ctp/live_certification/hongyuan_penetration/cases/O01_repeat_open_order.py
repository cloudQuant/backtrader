#!/usr/bin/env python
"""O01: Verify that the number of repeated open order submissions can be counted (optional)"""
            ...
            with started_store(env_key, stop_on_exit=False) as (store, config, ek):
                ...
                class RepeatOpenStrategy(bt.Strategy):
                    ...
                    def next(self):
                        ...
                        # Three identical submissions in one bar are what makes
                        # the duplicate monitor fire deterministically.
