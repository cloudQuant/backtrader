...
def test_78_0078_0855_donchian_channels_system() -> None:
    ...
    _close(metrics.get('max_drawdown'), 0.07155226862251729, tol=1.000000e-06, key='max_drawdown')
    _close(metrics.get('annual_return'), 0.013719655559591017, tol=1.000000e-06, key='annual_return')
    _close(metrics.get('return_rate'), 0.00023037346199590111, tol=1.000000e-06, key='return_rate')
