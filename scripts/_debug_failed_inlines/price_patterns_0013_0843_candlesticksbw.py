...
def test_13_0013_0843_candlesticksbw() -> None:
    ...
    _close(metrics.get('max_drawdown'), 0.1747158581298419, tol=1.000000e-06, key='max_drawdown')
    _close(metrics.get('annual_return'), 0.030757890176028112, tol=1.000000e-06, key='annual_return')
    _close(metrics.get('return_rate'), 0.000512168819155518, tol=1.000000e-06, key='return_rate')
