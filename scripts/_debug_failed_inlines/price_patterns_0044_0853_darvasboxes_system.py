...
def test_44_0044_0853_darvasboxes_system() -> None:
    ...
    _close(metrics.get('max_drawdown'), 0.08897010652417081, tol=1.000000e-06, key='max_drawdown')
    _close(metrics.get('annual_return'), -0.04502628425929777, tol=1.000000e-06, key='annual_return')
    _close(metrics.get('return_rate'), -0.000778903266405885, tol=1.000000e-06, key='return_rate')
