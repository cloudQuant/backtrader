...
def test_260_0259_0811_rsi_slowdown() -> None:
    ...
    _close(metrics.get('max_drawdown'), 0.1069429442698035, tol=1.000000e-06, key='max_drawdown')
    _close(metrics.get('annual_return'), -0.02480140601778963, tol=1.000000e-06, key='annual_return')
    _close(metrics.get('return_rate'), -0.00042459012563106173, tol=1.000000e-06, key='return_rate')
