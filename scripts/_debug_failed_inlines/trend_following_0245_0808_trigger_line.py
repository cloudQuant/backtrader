...
def test_244_0245_0808_trigger_line() -> None:
    ...
    _close(metrics.get('max_drawdown'), 0.19998280233892615, tol=1.000000e-06, key='max_drawdown')
    _close(metrics.get('annual_return'), -0.007613433028951189, tol=1.000000e-06, key='annual_return')
    _close(metrics.get('return_rate'), -0.00012920834703968376, tol=1.000000e-06, key='return_rate')
