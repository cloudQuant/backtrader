...
def test_261_0260_0812_delta_wpr() -> None:
    ...
    _close(metrics.get('max_drawdown'), 0.06113019453102578, tol=1.000000e-06, key='max_drawdown')
    _close(metrics.get('annual_return'), 0.0418519009634283, tol=1.000000e-06, key='annual_return')
    _close(metrics.get('return_rate'), 0.0006931597092920347, tol=1.000000e-06, key='return_rate')
