...
def test_245_0246_0816_i4_drf_v3() -> None:
    ...
    _close(metrics.get('max_drawdown'), 0.18306523176790124, tol=1.000000e-06, key='max_drawdown')
    _close(metrics.get('annual_return'), -0.07182907764141996, tol=1.000000e-06, key='annual_return')
    _close(metrics.get('return_rate'), -0.001260193710650358, tol=1.000000e-06, key='return_rate')
