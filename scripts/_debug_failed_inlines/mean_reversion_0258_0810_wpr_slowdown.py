...
def test_259_0258_0810_wpr_slowdown() -> None:
    ...
    _close(metrics.get('max_drawdown'), 0.08507156843036857, tol=1.000000e-06, key='max_drawdown')
    _close(metrics.get('annual_return'), -0.0027762142820423664, tol=1.000000e-06, key='annual_return')
    _close(metrics.get('return_rate'), -4.700110453462814e-05, tol=1.000000e-06, key='return_rate')
