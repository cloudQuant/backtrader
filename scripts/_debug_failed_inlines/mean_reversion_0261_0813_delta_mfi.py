...
def test_262_0261_0813_delta_mfi() -> None:
    ...
    _close(metrics.get('max_drawdown'), 0.12242245877654401, tol=1.000000e-06, key='max_drawdown')
    _close(metrics.get('annual_return'), -0.04502628425927268, tol=1.000000e-06, key='annual_return')
    _close(metrics.get('return_rate'), -0.0007789032664054406, tol=1.000000e-06, key='return_rate')
    _close(metrics.get('sharpe_ratio'), -5.3519229061332, tol=5.351923e-06, key='sharpe_ratio')
    _close(metrics.get('sqn'), -0.7021332366484727, tol=1.000000e-06, key='sqn')
    _activity = (
