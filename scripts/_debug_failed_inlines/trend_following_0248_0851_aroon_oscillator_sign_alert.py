...
def test_247_0248_0851_aroon_oscillator_sign_alert() -> None:
    ...
    _close(metrics.get('max_drawdown'), 0.0849497394871393, tol=1.000000e-06, key='max_drawdown')
    _close(metrics.get('annual_return'), 0.07988630694472991, tol=1.000000e-06, key='annual_return')
    _close(metrics.get('return_rate'), 0.0012993554719378587, tol=1.000000e-06, key='return_rate')
