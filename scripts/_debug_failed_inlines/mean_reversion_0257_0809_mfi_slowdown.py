...
def test_258_0257_0809_mfi_slowdown() -> None:
    ...
    _close(metrics.get('max_drawdown'), 0.27429270075756224, tol=1.000000e-06, key='max_drawdown')
    _close(metrics.get('annual_return'), -0.1093230303298389, tol=1.000000e-06, key='annual_return')
    _close(metrics.get('return_rate'), -0.001957314290456485, tol=1.000000e-06, key='return_rate')
    _close(metrics.get('sharpe_ratio'), -6.049902425934021, tol=6.049902e-06, key='sharpe_ratio')
    _close(metrics.get('sqn'), -0.787592592564154, tol=1.000000e-06, key='sqn')
    _activity = (
