...
def test_11_0011_0384_ais2_trading_robot() -> None:
    ...
    _close(metrics.get('max_drawdown'), 0.4755529801986247, tol=1.000000e-06, key='max_drawdown')
    _close(metrics.get('annual_return'), 2.973316064294941, tol=2.973316e-06, key='annual_return')
    _close(metrics.get('return_rate'), 0.0011443449874456336, tol=1.000000e-06, key='return_rate')
    _close(metrics.get('sharpe_ratio'), 5.495326155136925, tol=5.495326e-06, key='sharpe_ratio')
    _activity = (
