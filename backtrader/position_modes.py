...
_VALID_DUAL_SIDE_COMBOS = {
    ...
    (False, POSITION_SIDE_LONG, POSITION_OFFSET_CLOSE_TODAY),
    (False, POSITION_SIDE_LONG, POSITION_OFFSET_CLOSE_YESTERDAY),
    (True, POSITION_SIDE_SHORT, POSITION_OFFSET_CLOSE_TODAY),
    (True, POSITION_SIDE_SHORT, POSITION_OFFSET_CLOSE_YESTERDAY),
}
