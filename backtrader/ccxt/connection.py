...
class ConnectionManager:
    ...
    def get_missed_data(self, symbol: str, timeframe: str, since: int, limit: int = 1000) -> List:
        ...
        """
        try:
            return self.store.fetch_ohlcv(symbol, timeframe=timeframe, since=since, limit=limit)
        except Exception as e:
