...
class ConfigTab(BokehTab):
    ...
    def _get_panel(self):
        ...
        # Strategy parameters + data feeds
        if strategy is not None:
            widgets.extend(self._build_params_widgets(strategy, text_color))
            widgets.extend(self._build_data_widgets(strategy, text_color))
    ...
    def _build_params_widgets(self, strategy, text_color):
        """Build the strategy-name heading + parameters table widgets."""
        widgets = []
        # Strategy name
    ...
    def _build_data_widgets(self, strategy, text_color):
        """Build the data-feeds heading + data-info table widgets."""
        widgets = []
