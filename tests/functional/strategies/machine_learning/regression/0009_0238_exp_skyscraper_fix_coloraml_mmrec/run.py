...
from strategy_skyscraper_fix_coloraml_mmrec import Mt5PandasFeed, ExpSkyscraperFixColorAMLMMRecStrategy, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(ExpSkyscraperFixColorAMLMMRecStrategy, **config.get('params', {}))
...
def main():
    parser = argparse.ArgumentParser(description='Run Exp_Skyscraper_Fix_ColorAML_MMRec backtest')
