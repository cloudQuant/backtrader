...
class ExpSkyscraperFixColorAMLMMRecStrategy(bt.Strategy):
    params = dict(
        point_size=0.01,
        lot_min=0.01,
        lot_max=100.0,
    ...
    def _a_signals(self):
        ...
        return {
            ...
            'flip_to_buy': self._has_value(color_now) and self._has_value(color_prev) and color_now == 0.0 and color_prev != 0.0,
            'flip_to_sell': self._has_value(color_now) and self._has_value(color_prev) and color_now == 1.0 and color_prev != 1.0,
        }
    ...
    def _current_mm(self, system, side):
        ...
        return mm, mode, stop_points

    def _size_for_entry(self, system, side):
        mm, mode, stop_points = self._current_mm(system, side)
