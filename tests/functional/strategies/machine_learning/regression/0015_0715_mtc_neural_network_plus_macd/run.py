...
from strategy_mtc_neural_network_plus_macd import MTCNeuralNetworkPlusMACDStrategy, Mt5PandasFeed, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — MTC Neural Network plus MACD\n' + '=' * 60)
    for key in [
