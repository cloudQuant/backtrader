...
from strategy_fuzzy_logic import FuzzyLogicFeed, FuzzyLogicStrategy, compute_fuzzy_decision, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Fuzzy Logic\n' + '=' * 60)
    for key in [
        'fromdate', 'todate', 'bars_base', 'bars_signal', 'bar_num', 'signal_count', 'buy_count', 'sell_count',
