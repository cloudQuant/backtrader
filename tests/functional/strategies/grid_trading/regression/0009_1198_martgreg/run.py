...
import yaml
from strategy_martgreg import MartGregStrategy, Mt5PandasFeed, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — MartGreg\n' + '=' * 60)
    for key in [
        'fromdate', 'todate', 'bars', 'bar_num', 'buy_count', 'sell_count', 'trade_count',
        'win_count', 'loss_count', 'loss_streak', 'initial_cash', 'final_value', 'net_pnl',
