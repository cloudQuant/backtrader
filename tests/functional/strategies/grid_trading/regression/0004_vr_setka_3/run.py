...
from strategy_vr_setka_3 import SetkaFeed, VrSetka3Strategy, build_setka_frame, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — VR---SETKA---3\n' + '=' * 60)
    for key in [
        'fromdate', 'todate', 'bars', 'bar_num', 'signal_count', 'buy_count', 'sell_count', 'trade_count',
        'completed_orders', 'rejected_orders', 'layers_open', 'initial_cash', 'final_value', 'net_pnl',
