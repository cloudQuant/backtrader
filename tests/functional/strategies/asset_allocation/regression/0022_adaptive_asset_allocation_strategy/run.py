...
from strategy_adaptive_asset_allocation import AdaptiveAllocationStrategy, load_mt5_csv, prepare_asset_data
...
def main():
    ...
    print(f"Loaded adaptive allocation bars: {len(inputs['aligned_index'])}")
