...
from strategy_composite_asset_allocation import (
    ASSET_NAMES,
    TRADED_NAMES,
    CompositeAssetAllocationStrategy,
    load_mt5_csv,
    prepare_composite_allocation_inputs,
)
...
def print_results(metrics):
    ...
    print(f"  Last trend asset:    {metrics['trend_asset_last']}")
    print(f"  Last macro asset:    {metrics['macro_asset_last']}")
...
def main():
    ...
    print(f"Loaded composite-allocation bars: {len(inputs['aligned_index'])}")
