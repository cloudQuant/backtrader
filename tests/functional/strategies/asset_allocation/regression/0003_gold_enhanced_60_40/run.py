...
from strategy_gold_enhanced_60_40 import (
    GoldEnhanced6040SignalFeed,
    GoldEnhanced6040Strategy,
    SIGNAL_ASSETS,
    TRADE_ASSETS,
    load_mt5_csv,
    prepare_enhanced_60_40_data,
)
...
def main():
    ...
    print(f"Loaded enhanced 60/40 bars: {len(inputs['signal_df'])}")
