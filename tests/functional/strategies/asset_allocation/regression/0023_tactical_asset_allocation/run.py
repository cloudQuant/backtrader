...
from strategy_tactical_asset_allocation import (
    ASSET_NAMES,
    TacticalAssetAllocationSignalFeed,
...
def print_results(metrics):
    ...
    print(f"  Offensive months:    {metrics['offensive_months']}")
    print(f"  Defensive months:    {metrics['defensive_months']}")
    print(f"  Neutral months:      {metrics['neutral_months']}")
...
def run(plot=False):
    ...
    print(f"Loaded tactical allocation bars: {len(frame['signal_df'])}")
