...
from strategy_dual_asset_leveraged_portfolio import (
    ASSET_NAMES,
    DualAssetLeveragedStrategy,
    load_mt5_csv,
    prepare_dual_asset_inputs,
)
...
def print_results(metrics):
    ...
    print(f"  Last crisis flag:    {metrics['crisis_flag_last']}")
    print(f"  Last IVV target:     {metrics['ivv_target_last']}")
    print(f"  Last XAU target:     {metrics['xau_target_last']}")
...
def main():
    ...
    print(f"Loaded dual-asset-leveraged bars: {len(inputs['aligned_index'])}")
