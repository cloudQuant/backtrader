...
from strategy_optimal_gold_allocation import OptimalGoldAllocationStrategy, build_weight_lookup, load_mt5_csv, prepare_allocation_inputs
...
def print_results(metrics):
    ...
    print(f"  Avg gold weight:     {metrics['avg_gold_weight']:.2%}")
...
def main():
    ...
    print(f"Loaded optimal-gold-allocation bars: {len(inputs['aligned_index'])}")
