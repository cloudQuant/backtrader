...
from strategy_volatility_managed_portfolio_gold import (
    VolatilityManagedGoldFeed,
    VolatilityManagedGoldStrategy,
    load_mt5_csv,
    prepare_volatility_managed_features,
)
...
def main():
    ...
    print(f"Loaded volatility-managed bars: {len(inputs['data'])}")
