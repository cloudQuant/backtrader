...
from strategy_gold_tactical_allocation import (
    ASSET_NAMES,
    GoldTacticalAllocationStrategy,
    TacticalAllocationSignalFeed,
    load_mt5_csv,
    prepare_tactical_allocation_data,
)
...
def main():
    ...
    print(f"Loaded tactical allocation bars: {len(inputs['signal_df'])}")
