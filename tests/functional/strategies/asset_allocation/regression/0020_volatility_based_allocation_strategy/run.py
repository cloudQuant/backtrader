...
from strategy_volatility_based_allocation import VolatilityBasedAllocationStrategy, load_mt5_csv, prepare_allocation_inputs
...
def print_results(metrics):
    ...
    print(f"  Low/Normal vol:      {metrics['low_vol_days']}/{metrics['normal_vol_days']}")
    print(f"  High/Extreme vol:    {metrics['high_vol_days']}/{metrics['extreme_vol_days']}")
...
def main():
    ...
    print(f"Loaded volatility-allocation bars: {len(inputs['vol_df'])}")
