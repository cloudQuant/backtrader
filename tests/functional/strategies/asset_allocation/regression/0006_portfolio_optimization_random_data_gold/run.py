...
from strategy_portfolio_optimization_random_data_gold import (
    ASSETS,
    PortfolioOptimizationRandomDataGoldStrategy,
    PortfolioOptimizationSignalFeed,
    load_mt5_csv,
    prepare_portfolio_optimization_data,
)
...
def print_results(metrics):
    ...
    print(f"  Avg corr:            {metrics['avg_pair_corr']:.4f}")
    print(f"  Avg weights:         XAU={metrics['avg_weight_xauusd']:.2%} XAG={metrics['avg_weight_xagusd']:.2%} GDX={metrics['avg_weight_gdx']:.2%}")
