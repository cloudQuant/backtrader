...
from strategy_commodity_seasonality_front_running import CommoditySeasonalityFrontRunFeed, CommoditySeasonalityFrontRunningStrategy, load_mt5_csv, prepare_front_running_features
...
def print_results(metrics):
    ...
    print(f"  Front-run days:      {metrics['front_run_days']}")
    print(f"  Strong days:         {metrics['strong_days']}")
    print(f"  Weak days:           {metrics['weak_days']}")
...
def main():
    ...
    print(f"Loaded seasonality bars: {len(inputs['data'])}")
