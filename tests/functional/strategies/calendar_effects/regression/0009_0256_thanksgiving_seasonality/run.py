...
from strategy_thanksgiving_seasonality import (
    Mt5ThanksgivingSeasonalityFeed,
    ThanksgivingSeasonalityStrategy,
    load_mt5_csv,
    prepare_thanksgiving_features,
)
...
def print_results(metrics):
    ...
    print(f"  Long setups:       {metrics['long_setup_count']}")
    print(f"  Short setups:      {metrics['short_setup_count']}")
    print(f"  Long entries:      {metrics['long_entry_count']}")
    print(f"  Short entries:     {metrics['short_entry_count']}")
