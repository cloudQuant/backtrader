...
from strategy_bitcoin_seasonal_anomalies import BitcoinSeasonalAnomaliesStrategy, load_mt5_csv, prepare_seasonal_inputs
...
def print_results(metrics):
    ...
    print(f"  In/Out market days:  {metrics['in_market_days']}/{metrics['out_market_days']}")
...
def main():
    ...
    print(f"Loaded bitcoin-seasonal-anomalies bars: {len(inputs['prepared'])}")
