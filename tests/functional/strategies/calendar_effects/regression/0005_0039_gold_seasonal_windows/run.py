...
from strategy_gold_seasonal_windows import (
    GoldSeasonalWindowsFeed,
    GoldSeasonalWindowsStrategy,
    load_mt5_csv,
    prepare_gold_seasonal_windows_features,
)
...
def main():
    ...
    print(f"Loaded seasonal window bars: {len(inputs['data'])}")
