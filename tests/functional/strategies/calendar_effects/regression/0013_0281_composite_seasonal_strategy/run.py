...
from strategy_composite_seasonal import (
    CompositeSeasonalFeed,
    CompositeSeasonalStrategy,
    load_mt5_csv,
    prepare_composite_seasonal_features,
)
...
def main():
    ...
    print(f"Loaded composite seasonal bars: {len(inputs['data'])}")
