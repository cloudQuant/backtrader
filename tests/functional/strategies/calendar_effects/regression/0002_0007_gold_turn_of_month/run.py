...
from strategy_gold_turn_of_month import GoldTurnOfMonthStrategy, Mt5TurnOfMonthFeed, load_mt5_csv, prepare_turn_of_month_features
...
def print_report(metrics):
    print('\n' + '=' * 60)
    print('BACKTEST RESULTS — Gold Turn of Month Effect')
    print('=' * 60)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Run Gold Turn of Month Effect backtest.')
