...
from strategy_seasonal_trading import SeasonalTradingFeed, SeasonalTradingStrategy, load_mt5_csv, prepare_seasonal_features
...
def main():
    ...
    print(f"Loaded seasonal bars: {len(inputs['data'])}")
