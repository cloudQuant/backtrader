...
from strategy_expert_news import ExpertNewsStrategy, Mt5PandasFeed, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Expert NEWS\n' + '=' * 60)
    for key in [
        'fromdate', 'todate', 'bars', 'bar_num', 'pending_triggers', 'buy_count', 'sell_count', 'trade_count',
