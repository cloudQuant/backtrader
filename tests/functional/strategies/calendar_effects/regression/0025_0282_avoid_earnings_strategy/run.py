...
from strategy_avoid_earnings import (
    AvoidEarningsFeed,
    AvoidEarningsStrategy,
    load_mt5_csv,
    prepare_avoid_earnings_features,
)
...
def print_results(metrics):
    ...
    print(f"  Avoid days:          {metrics['avoid_days']}")
    print(f"  Reduced days:        {metrics['reduced_days']}")
...
def main():
    ...
    print(f"Loaded avoid-earnings bars: {len(frame['data'])}")
