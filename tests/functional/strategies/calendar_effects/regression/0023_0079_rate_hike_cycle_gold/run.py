...
from strategy_rate_hike_cycle_gold import (
    RateHikeCycleGoldStrategy,
    RateHikeSignalFeed,
    load_mt5_csv,
    prepare_rate_hike_inputs,
)
...
def print_results(metrics):
    ...
    print(f"  Hike events:         {metrics['hike_event_count']}")
    print(f"  Signal days:         {metrics['signal_days']} (long={metrics['long_signal_days']}, short={metrics['short_signal_days']})")
