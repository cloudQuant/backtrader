...
from strategy_december_opex_seasonality import (
    Mt5DecemberOpExFeed,
    DecemberOpExSeasonalityStrategy,
    load_mt5_csv,
    prepare_december_opex_features,
)
...
def print_results(metrics):
    ...
    print(f"  Entry setups:      {metrics['entry_setup_count']}")
    print(f"  Oversold boosts:   {metrics['oversold_boost_count']}")
    print(f"  Extended trades:   {metrics['extended_trade_count']}")
