...
from strategy_gold_seasonality_rotation import (
    GoldSeasonalityRotationFeed,
    GoldSeasonalityRotationStrategy,
    load_mt5_csv,
    prepare_seasonality_rotation_features,
)
...
def main():
    ...
    print(f"Loaded seasonality rotation bars: {len(inputs['data'])}")
