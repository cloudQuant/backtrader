...
from strategy_seasonal_sell_august import SeasonalSellAugustStrategy, SeasonalSellFeed, load_mt5_csv, prepare_seasonal_sell_features
...
def print_results(metrics):
    ...
    print(f"  Holding days:        {metrics['holding_days']}")
...
def main():
    ...
    print(f"Loaded seasonal sell bars: {len(inputs['data'])}")
