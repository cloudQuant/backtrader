...
from strategy_gold_seasonality import (
    Mt5SeasonalityFeed, GoldSeasonalityStrategy, load_mt5_csv, prepare_seasonality_features,
)
...
def upsert_global_summary(config, metrics):
    ...
    fieldnames = ['strategy_id', 'strategy_name', 'fromdate', 'todate', 'bars',
