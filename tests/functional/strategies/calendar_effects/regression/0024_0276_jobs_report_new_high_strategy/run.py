...
from strategy_jobs_report_new_high import (
    JobsReportNewHighFeed,
    JobsReportNewHighStrategy,
    load_mt5_csv,
    prepare_jobs_report_new_high_features,
)
...
def main():
    ...
    print(f"Loaded jobs-report-new-high bars: {len(frame['data'])}")
