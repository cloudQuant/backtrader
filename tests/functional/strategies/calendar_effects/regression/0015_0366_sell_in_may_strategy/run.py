...
from strategy_sell_in_may import SellInMayStrategy, SellInMayFeed, load_mt5_csv, prepare_sell_in_may_data
...
def main():
    ...
    print(f"Loaded sell-in-may bars: {len(inputs['prepared'])}")
