...
from strategy_cultural_calendar_gold import (
    CulturalCalendarGoldFeed,
    CulturalCalendarGoldStrategy,
    load_mt5_csv,
    prepare_cultural_calendar_features,
)
...
def print_results(metrics):
    ...
    print(f"  Signal days:         {metrics['calendar_signal_days']}")
    print(f"  Max exposure:        {metrics['max_target_exposure']:.2f}")
...
def run(plot=False):
    ...
    print(f"Loaded cultural-calendar bars: {len(frame['data'])}")
