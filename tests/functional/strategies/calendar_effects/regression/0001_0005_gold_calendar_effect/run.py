...
from strategy_gold_calendar_effect import GoldCalendarEffectStrategy, Mt5CalendarEffectFeed, load_mt5_csv, prepare_calendar_features
...
def print_report(metrics):
    print('\n' + '=' * 60)
    print('BACKTEST RESULTS — Gold Calendar Effect')
    print('=' * 60)
    ...
    print(f"  Time exits:        {metrics['time_exit_count']}")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Run Gold Calendar Effect backtest.')
