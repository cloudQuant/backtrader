...
from strategy_turn_of_month import TurnOfMonthFeed, TurnOfMonthStrategy, load_mt5_csv, prepare_turn_of_month_features
...
def print_results(metrics):
    ...
    print(f"  Window days:         {metrics['window_days']}")
