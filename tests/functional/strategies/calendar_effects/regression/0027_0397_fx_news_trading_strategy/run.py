...
from strategy_fx_news_trading import FXNewsFeed, FXNewsTradingStrategy, load_mt5_csv, prepare_news_features
...
def print_results(metrics):
    ...
    print(f"  Event days:          {metrics['event_days']}")
...
def main():
    ...
    print(f"Loaded FX news bars: {len(inputs['data'])}")
