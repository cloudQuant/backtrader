...
from strategy_bitcoin_seasonality import BitcoinSeasonalityFeed, BitcoinSeasonalityStrategy, load_mt5_csv, prepare_intraday_seasonality_features
...
def print_results(metrics):
    ...
    print(f"  Seasonality hours:   {metrics['seasonality_hours']}")
...
def main():
    ...
    print(f"Loaded bitcoin-seasonality proxy bars: {len(inputs['data'])}")
