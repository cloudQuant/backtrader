...
from strategy_moving_average_crossover import Mt5PandasFeed, MovingAverageCrossoverStrategy, load_mt5_csv
...
def print_report(metrics):
    ...
    print(f"  Martingale mode:   {metrics['use_martingale']}")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Moving Average Crossover Backtest Runner')
