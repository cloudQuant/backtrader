...
from strategy_tail_risk_ma_warning import Mt5TailRiskFeed, TailRiskMAWarningStrategy, load_mt5_csv, prepare_tail_risk_features
...
def print_report(metrics):
    print('\n' + '=' * 60)
    print('BACKTEST RESULTS — Tail Risk MA Warning')
    print('=' * 60)
    ...
    print(f"  Risk months:              {metrics['risk_month_count']}")
    print(f"  Normal months:            {metrics['normal_month_count']}")
    print(f"  State switches:           {metrics['state_switch_count']}")
    ...
    print(f"  Monthly rows:             {metrics['monthly_rows']}")
    print(f"  Below MA months:          {metrics['below_ma_months']}")
    print(f"  Below MA pct:             {metrics['below_ma_pct']:.2f}%")
    print(f"  Large loss months:        {metrics['large_loss_months']}")
    print(f"  Large loss below MA:      {metrics['large_loss_below_ma']}")
    print(f"  Large loss below MA pct:  {metrics['large_loss_below_ma_pct']:.2f}%")
    print('=' * 60)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Tail Risk MA Warning Runner')
