...
from strategy_grid_trading_delta_hedge import GridTradingDeltaHedgeStrategy, load_mt5_csv, prepare_grid_data
...
def print_results(metrics):
    ...
    print(f"  Grid resets:         {metrics['grid_reset_count']}")
