...
from strategy_crossing_moving_average import Mt5PandasFeed, CrossingMovingAverageStrategy, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(CrossingMovingAverageStrategy, **config.get('params', {}))
