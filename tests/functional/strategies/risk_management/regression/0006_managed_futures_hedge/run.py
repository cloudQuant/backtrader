...
from strategy_managed_futures_hedge import (
    Mt5ManagedFuturesHedgeFeed, ManagedFuturesHedgeStrategy, load_mt5_csv, prepare_managed_futures_hedge_features,
)
...
def load_data(config):
    ...
    raw = load_mt5_csv(
        Path(__file__).resolve().parents[6] / 'tests' / 'datas' / data_file,
