...
from strategy_smoothing_average import Mt5PandasFeed, SmoothingAverageStrategy, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Smoothing Average\n' + '=' * 60)
    for key in [
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Run Smoothing Average backtest')
