...
from strategy_simplest_hedging_ea import Mt5PandasFeed, SimplestHedgingEaStrategy, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Simplest Hedging EA\n' + '=' * 60)
    for key in [
        'fromdate', 'todate', 'bars', 'bar_num', 'entry_cycle_count', 'buy_count', 'sell_count', 'trade_count',
        'completed_orders', 'rejected_orders', 'open_layers', 'initial_cash', 'final_value', 'net_pnl',
