...
from strategy_practical_pairs_trading import (
    PracticalPairsTradingStrategy,
    load_mt5_csv,
    prepare_pair_inputs,
)
...
def upsert_global_summary(config, metrics):
    ...
    rows.append({
        ...
        'symbol': f"{config['data']['asset_a_symbol']}/{config['data']['asset_b_symbol']}",
...
def print_results(metrics):
    ...
    print(f"  Long spread days:    {metrics['long_spread_days']}")
    print(f"  Short spread days:   {metrics['short_spread_days']}")
