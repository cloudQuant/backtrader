...
Example:
    To run the test directly::
        ...
        python tests/strategies/test_49_calmar_analyzer.py

    Or via pytest::

        pytest tests/strategies/test_49_calmar_analyzer.py -v
"""
...
def resolve_data_path(filename: str) -> Path:
    ...
    Note:
        The search order is:
        1. BASE_DIR / filename
        2. BASE_DIR.parent.parent.parent / filename
        3. BASE_DIR / "datas" / filename
        4. BASE_DIR.parent.parent.parent / "datas" / filename
    """
    search_paths = [
        BASE_DIR / filename,
