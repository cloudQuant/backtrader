...
from strategy_commodity_carry import CarryProxyFeed, CommodityCarryStrategy, load_mt5_csv, prepare_carry_proxy_data
...
def main():
    ...
    print(f"Loaded commodity carry proxy bars: {len(inputs['score_df'])}")
