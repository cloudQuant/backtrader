...
from strategy_gold_relative_value import (
    ASSETS,
    GoldRelativeValueSignalFeed,
    GoldRelativeValueStrategy,
    load_mt5_csv,
    prepare_relative_value_features,
)
...
def main():
    ...
    print(f"Loaded relative value bars: {len(inputs['signal_df'])}")
