...
from strategy_carry_trading import CarryProxyFeed, CarryTradingStrategy, load_mt5_csv, prepare_carry_proxy_data
...
def main():
    ...
    print(f"Loaded carry proxy bars: {len(inputs['score_df'])}")
