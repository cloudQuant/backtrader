...
from strategy_ema_prediction import (
    EmaPredictionFeed,
    EmaPredictionStrategy,
    Mt5PandasFeed,
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Exp_EMA_Prediction\n' + '=' * 60)
