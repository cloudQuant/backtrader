...
def load_mt5_csv(filepath, fromdate=None, todate=None, bar_shift_minutes=0):
    """Load an MT5-style CSV and normalize it into a Backtrader-ready DataFrame."""
