...
def load_mt5_csv(filepath, fromdate=None, todate=None, bar_shift_minutes=0):
    """Load MT5 style tab-separated file into a Backtrader-ready DataFrame.

    Args:
        filepath: Path to CSV source file.
    ...
    Returns:
        DataFrame indexed by parsed datetime with OHLCV/openinterest columns.
    """
