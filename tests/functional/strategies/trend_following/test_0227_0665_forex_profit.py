"""Inlined regression test for tests/functional/strategies/trend_following/regression/0227_0665_forex_profit.
...
_CONFIG = {
    'strategy': {
        'name': 'Forex_Profit',
        'source_ea': 'ea/0665_Forex_Profit(外汇交易利润)/forex_profit.mq5',
    },
    'data': {
        'symbol': 'XAUUSD',
        'timeframe': 'H1',
