"""Inlined regression test for tests/functional/strategies/trend_following/regression/0157_1315_darkcloud_mfi.
...
_CONFIG = {
    'strategy': {
        'name': 'Dark Cloud Cover / Piercing Line + MFI',
        'source_ea': 'ea/1315',
    },
    'data': {
        'symbol': 'XAUUSD',
...
def test_157_0157_1315_darkcloud_mfi() -> None:
    """Migrated regression test (runonce=True only).

    Originally located at tests/functional/strategies_regression/trend_following/0157_1315_darkcloud_mfi.
    """
    ...
    _close(metrics.get('final_value'), 1000031.1000000001, tol=1.000031e+00, key='final_value')
    _close(metrics.get('net_pnl'), 31.100000000093132, tol=3.110000e-05, key='net_pnl')
    _close(metrics.get('total_return_pct'), 0.0031100000000172656, tol=1.000000e-06, key='total_return_pct')
    _close(metrics.get('win_rate'), 100.0, tol=1.000000e-04, key='win_rate')
    _close(metrics.get('max_drawdown'), 0.005559999999997672, tol=1.000000e-06, key='max_drawdown')
    _close(metrics.get('sharpe_ratio'), 2.1057776418151715, tol=2.105778e-06, key='sharpe_ratio')
    _close(metrics.get('annual_return_pct'), 0.18430068280940592, tol=1.000000e-06, key='annual_return_pct')
