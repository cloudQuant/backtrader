...
def load_mt5_csv(filepath, fromdate=None, todate=None, bar_shift_minutes=0):
    """Load a tab-delimited MT5 OHLCV file and return a cleaned pandas frame.
    ...
    fromdate : datetime, optional
        Inclusive lower bound for filtering rows.
    todate : datetime, optional
        Inclusive upper bound for filtering rows.
    bar_shift_minutes : int, optional
        Number of minutes to shift timestamps for execution alignment.
