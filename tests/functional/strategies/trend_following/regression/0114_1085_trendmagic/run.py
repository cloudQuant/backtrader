...
from strategy_trendmagic import Mt5PandasFeed, TrendMagicFeed, TrendMagicStrategy, compute_trendmagic, load_mt5_csv, resample_frame
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Exp_TrendMagic\n' + '=' * 60)
    for key in [
