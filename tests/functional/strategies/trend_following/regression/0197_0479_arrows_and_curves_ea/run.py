...
from strategy_arrows_and_curves_ea import ArrowsAndCurvesEAStrategy, Mt5PandasFeed, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(ArrowsAndCurvesEAStrategy, **config.get('params', {}))
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — ARROWS_AND_CURVES_EA\n' + '=' * 60)
    for key in [
