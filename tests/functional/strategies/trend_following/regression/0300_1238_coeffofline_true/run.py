...
from strategy_coeffofline_true import CoeffOfLineTrueFeed, CoeffOfLineTrueStrategy, Mt5PandasFeed, build_coeffofline_true_frame, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — CoeffofLine_true\n' + '=' * 60)
    for key in [
