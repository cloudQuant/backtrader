...
from strategy_trend_following_macro import TrendFollowingMacroStrategy, load_mt5_csv, prepare_macro_inputs
...
def print_results(metrics):
    ...
    print(f"  Long/Short/Flat:     {metrics['long_days']}/{metrics['short_days']}/{metrics['flat_days']}")
