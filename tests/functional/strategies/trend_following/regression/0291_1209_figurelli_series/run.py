...
from strategy_figurelli_series import FigurelliSeriesFeed, FigurelliSeriesStrategy, Mt5PandasFeed, build_figurelli_series_frame, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — FigurelliSeries\n' + '=' * 60)
    for key in [
