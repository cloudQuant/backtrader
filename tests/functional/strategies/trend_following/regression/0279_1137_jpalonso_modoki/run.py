...
from strategy_jpalonso_modoki import JpAlonsoModokiStrategy, Mt5PandasFeed, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — JPALONSO-MODOKI\n' + '=' * 60)
    for key in [
