...
from strategy_20_200_pips import Mt5PandasFeed, Twenty200PipsStrategy, load_mt5_csv, resample_frame
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — 20_200 Pips EA\n' + '=' * 60)
    for key in [
        'fromdate', 'todate', 'bars_m15', 'bars_h1', 'bar_num', 'signal_count', 'buy_count', 'sell_count',
