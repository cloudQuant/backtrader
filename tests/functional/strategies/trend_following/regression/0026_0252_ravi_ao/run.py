...
from strategy_ravi_ao import Mt5PandasFeed, RaviAOStrategy, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(RaviAOStrategy, **config.get('params', {}))
...
def main():
    parser = argparse.ArgumentParser(description='Run Ravi_AO backtest')
