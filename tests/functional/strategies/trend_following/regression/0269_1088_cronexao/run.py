...
from strategy_cronexao import CronexAoFeed, CronexAoStrategy, Mt5PandasFeed, compute_cronexao, load_mt5_csv, resample_frame
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Exp_CronexAO\n' + '=' * 60)
    for key in [
        'fromdate', 'todate', 'bars_m15', 'bars_h8', 'bar_num', 'buy_signals', 'sell_signals',
