...
from strategy_multitrend_signal_kvn import Mt5PandasFeed, MultiTrendSignalKvnFeed, MultiTrendSignalKvnStrategy, build_multitrend_signal_kvn_frame, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — MultiTrend_Signal_KVN\n' + '=' * 60)
    for key in [
