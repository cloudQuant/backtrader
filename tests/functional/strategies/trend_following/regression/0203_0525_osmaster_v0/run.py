...
import yaml
from strategy_osmaster_v0 import Mt5PandasFeed, OsMaSterStrategy, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(OsMaSterStrategy, **config.get('params', {}))
