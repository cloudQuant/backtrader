...
from strategy_simple_macd import Mt5PandasFeed, SimpleMACDStrategy, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(SimpleMACDStrategy, **config.get('params', {}))
