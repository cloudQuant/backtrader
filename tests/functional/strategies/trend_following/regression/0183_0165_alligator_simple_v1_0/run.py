...
from strategy_alligator_simple_v1_0 import AlligatorSimpleStrategy, Mt5PandasFeed, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Alligator Simple v1.0\n' + '=' * 60)
    for key in [
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Run Alligator Simple v1.0 backtest')
