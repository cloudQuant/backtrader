...
import yaml
from strategy_brakeout_trader import Mt5PandasFeed, BrakeoutTraderStrategy, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(BrakeoutTraderStrategy, **config.get('params', {}))
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Brakeout Trader\n' + '=' * 60)
