...
from strategy_percentage_crossover_channel import Mt5PandasFeed, PercentageCrossoverChannelStrategy, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — PERCENTAGE_CROSSOVER_CHANNEL\n' + '=' * 60)
    for key in [
