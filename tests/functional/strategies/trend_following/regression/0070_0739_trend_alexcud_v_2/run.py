...
from strategy_trend_alexcud_v_2 import ACFeed, Mt5PandasFeed, TrendAlexcudV2Strategy, compute_ac, load_mt5_csv, resample_frame
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — TREND_alexcud_v_2\n' + '=' * 60)
    for key in [
        'fromdate', 'todate', 'bars_base', 'bars_tf1', 'bars_tf2', 'bars_tf3', 'bar_num', 'signal_count', 'buy_count', 'sell_count',
        'trade_count', 'completed_orders', 'rejected_orders', 'initial_cash', 'final_value', 'net_pnl', 'total_return_pct',
        'total_trades', 'won', 'lost', 'win_rate', 'profit_factor', 'sharpe_ratio', 'annual_return_pct', 'max_drawdown', 'sqn',
    ]:
        value = metrics[key]
