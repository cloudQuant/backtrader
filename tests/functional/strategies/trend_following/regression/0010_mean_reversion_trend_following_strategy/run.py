...
from strategy_mean_reversion_trend_following import CombinedSignalFeed, MeanReversionTrendFollowingStrategy, load_mt5_csv, prepare_combined_features
...
def print_results(metrics):
    ...
    print(f"  Long bias days:      {metrics['long_bias_days']}")
    print(f"  Short bias days:     {metrics['short_bias_days']}")
    print(f"  Flat bias days:      {metrics['flat_bias_days']}")
