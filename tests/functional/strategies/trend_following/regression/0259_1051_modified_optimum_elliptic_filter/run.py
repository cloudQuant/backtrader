...
from strategy_modified_optimum_elliptic_filter import (
    ModifiedOptimumEllipticFilterFeed,
    ModifiedOptimumEllipticFilterStrategy,
    Mt5PandasFeed,
    compute_modified_optimum_elliptic_filter,
    load_mt5_csv,
    resample_frame,
)
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Exp_Modified_Optimum_Elliptic_Filter\n' + '=' * 60)
    for key in [
        'fromdate', 'todate', 'bars_m15', 'bars_h4', 'bar_num', 'buy_signal_count', 'sell_signal_count',
