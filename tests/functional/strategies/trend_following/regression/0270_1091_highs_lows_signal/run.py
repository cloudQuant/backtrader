...
from strategy_highs_lows_signal import HighsLowsSignalFeed, HighsLowsSignalStrategy, Mt5PandasFeed, compute_highs_lows_signal, load_mt5_csv, resample_frame
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Exp_HighsLowsSignal\n' + '=' * 60)
    for key in [
