...
class ExpAroonOscillatorSignAlertStrategy(bt.Strategy):
    ...
    def __init__(self):
        ...
        self.ind = AroonOscillatorSignAlert(self.signal_data, atr_period=self.p.atr_period, aroon_period=self.p.aroon_period, up_level=self.p.up_level, dn_level=self.p.dn_level)
        self.bar_num = 0
        self.signal_count = 0
        self.trade_count = 0
        self.buy_count = 0
