...
import yaml
from strategy_doublema_crossover import Mt5PandasFeed, DoubleMACrossoverStrategy, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(DoubleMACrossoverStrategy, **config.get('params', {}))
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — DoubleMA Crossover\n' + '=' * 60)
