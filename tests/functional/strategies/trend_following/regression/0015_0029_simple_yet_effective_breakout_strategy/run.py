...
from strategy_breakout_strategy import BreakoutStrategy, Mt5PandasFeed, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60)
    print('BACKTEST RESULTS — Simple Yet Effective Breakout Strategy')
    print('=' * 60)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Simple Yet Effective Breakout Strategy Backtest Runner')
