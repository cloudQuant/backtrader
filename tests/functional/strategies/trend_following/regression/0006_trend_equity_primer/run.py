...
from strategy_trend_equity_primer import (
    TrendEquityPrimerFeed,
    TrendEquityPrimerStrategy,
    load_mt5_csv,
    prepare_trend_equity_primer_features,
)
...
def print_results(metrics):
    ...
    print(f"  Position method:   {metrics['position_method']}")
    ...
    print(f"  Avg cash weight:   {metrics['avg_cash_weight']}")
    print(f"  Avg volatility:    {metrics['avg_volatility']}")
