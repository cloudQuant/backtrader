...
from strategy_escape import EscapeStrategy, Mt5PandasFeed, load_mt5_csv, resample_frame
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — escape\n' + '=' * 60)
    for key in [
        'fromdate', 'todate', 'bars_base', 'bars_m5', 'bar_num', 'signal_count', 'buy_count', 'sell_count',
