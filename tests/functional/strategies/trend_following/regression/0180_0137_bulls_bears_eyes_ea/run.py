...
from strategy_bulls_bears_eyes_ea import BullsBearsEyesStrategy, Mt5PandasFeed, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(BullsBearsEyesStrategy, **config['params'])
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — BullsBearsEyes EA\n' + '=' * 60)
    for key in [
