...
from strategy_colorjvariation import Mt5PandasFeed, ColorJVariationStrategy, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(ColorJVariationStrategy, **config.get('params', {}))
...
def print_report(metrics):
    print('\n' + '=' * 60)
    print('BACKTEST RESULTS — COLOR JVARIATION')
    print('=' * 60)
    for key in [
