...
from strategy_lemansignal import ExpLeManSignalStrategy, Mt5PandasFeed, load_mt5_csv
...
def build_cerebro(cfg, frame):
    ...
    cerebro.addstrategy(ExpLeManSignalStrategy, **sp)
