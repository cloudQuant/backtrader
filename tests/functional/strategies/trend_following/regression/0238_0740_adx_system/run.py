...
from strategy_adx_system import ADXSystemStrategy, Mt5PandasFeed, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(ADXSystemStrategy, **config.get('params', {}))
