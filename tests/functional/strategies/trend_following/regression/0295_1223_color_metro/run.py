...
from strategy_color_metro import ColorMetroFeed, ColorMetroStrategy, Mt5PandasFeed, build_color_metro_frame, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(ColorMetroStrategy, **strategy_params)
