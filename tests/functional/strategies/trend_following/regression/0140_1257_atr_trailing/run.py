...
import yaml
from strategy_atr_trailing import Mt5PandasFeed, ATRTrailingStrategy, load_mt5_csv
...
def print_report(m):
    print('\n'+'='*60+'\nBACKTEST RESULTS — ATR Trailing Stop\n'+'='*60)
