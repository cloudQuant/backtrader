...
from strategy_color_schaff_wpr_trend_cycle import (
    ColorSchaffWPRTrendCycleFeed,
    ColorSchaffWPRTrendCycleStrategy,
    Mt5PandasFeed,
    compute_color_schaff_wpr_trend_cycle,
    load_mt5_csv,
    resample_frame,
)
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Exp_ColorSchaffWPRTrendCycle\n' + '=' * 60)
