...
from strategy_trend_equity_decomposition import (
    TrendEquityDecompositionFeed,
    TrendEquityDecompositionStrategy,
    load_mt5_csv,
    prepare_trend_equity_features,
)
...
def print_results(metrics):
    ...
    print(f"  Decomposition:     {metrics['decomposition_type']}")
    print(f"  Signal changes:    {metrics['signal_change_count']}")
    print(f"  Long/Flat days:    {metrics['long_days']}/{metrics['flat_days']}")
    print(f"  Avg exposure:      {metrics['avg_exposure']}")
    print(f"  Avg overlay:       {metrics['avg_overlay']}")
