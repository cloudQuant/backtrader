...
from strategy_bulls_bears_eyes import BullsBearsEyesFeed, BullsBearsEyesStrategy, Mt5PandasFeed, build_bulls_bears_eyes_frame, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — BullsBearsEyes\n' + '=' * 60)
    for key in [
