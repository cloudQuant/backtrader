...
from strategy_darkcloud_mfi import Mt5PandasFeed, DarkCloudMfiStrategy, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(DarkCloudMfiStrategy, **config.get('params', {}))
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Dark Cloud Cover / Piercing Line + MFI\n' + '=' * 60)
    for key in [
