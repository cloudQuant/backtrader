...
from strategy_morningstar_rsi import Mt5PandasFeed, MorningStarRsiStrategy, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(MorningStarRsiStrategy, **config.get('params', {}))
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Morning/Evening Star + RSI\n' + '=' * 60)
    for key in [
