...
import yaml
from strategy_2ma_rsi import Mt5PandasFeed, TwoMaRsiStrategy, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(TwoMaRsiStrategy, **config.get('params', {}))
