...
from strategy_brake_exp import Mt5PandasFeed, BrakeExpStrategy, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(BrakeExpStrategy, **config.get('params', {}))
...
def print_report(metrics):
    print('\n' + '=' * 60)
    print('BACKTEST RESULTS — BRAKE EXP')
    print('=' * 60)
    for key in [
