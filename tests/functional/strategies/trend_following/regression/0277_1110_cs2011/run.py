...
from strategy_cs2011 import Cs2011Strategy, Mt5PandasFeed, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — CS2011\n' + '=' * 60)
    for key in [
        'fromdate', 'todate', 'bars', 'bar_num', 'signal_count', 'buy_signal_count', 'sell_signal_count',
        'completed_order_count', 'rejected_order_count', 'buy_count', 'sell_count', 'trade_count',
        'initial_cash', 'final_cash', 'final_value', 'net_pnl', 'total_return_pct', 'total_trades',
        'won', 'lost', 'win_rate', 'profit_factor', 'open_position_size', 'open_position_price',
