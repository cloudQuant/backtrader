"""Inlined regression test for tests/functional/strategies/trend_following/regression/0165_1329_price_cross_ma_adx.
...
_CONFIG = {
    'strategy': {
        ...
        'source_ea': 'ea/1329_MQL5向导_-_基于价格交叉移动平均线并由ADX确认的交易信�?expert_adx_ma.mq5',
    },
    'data': {
        'symbol': 'XAUUSD',
        'timeframe': 'M15',
