...
from strategy_wprsisignal import ExpWPRSISignalStrategy, Mt5PandasFeed, load_mt5_csv
...
def build_cerebro(cfg, frame):
    ...
    cerebro.addstrategy(ExpWPRSISignalStrategy, **sp)
