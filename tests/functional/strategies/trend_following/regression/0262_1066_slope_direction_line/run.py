...
from strategy_slope_direction_line import (
    Mt5PandasFeed,
    SlopeDirectionLineFeed,
    SlopeDirectionLineStrategy,
    compute_slope_direction_line,
    load_mt5_csv,
    resample_frame,
)
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Exp_SlopeDirectionLine\n' + '=' * 60)
    for key in [
