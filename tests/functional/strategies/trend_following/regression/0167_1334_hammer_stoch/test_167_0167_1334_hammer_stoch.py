"""Inlined regression test for tests/functional/strategies/trend_following/regression/0167_1334_hammer_stoch.
...
_CONFIG = {
    'strategy': {
        ...
        'source_ea': 'ea/1334_MQL5_向导_-_基于_锤头_上吊线形态的交易信号_+_Stochastic',
    },
    'data': {
        'symbol': 'XAUUSD',
        'timeframe': 'M15',
