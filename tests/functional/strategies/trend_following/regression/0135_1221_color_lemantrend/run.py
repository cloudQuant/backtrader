...
from strategy_color_lemantrend import ColorLeManTrendFeed, ColorLeManTrendStrategy, Mt5PandasFeed, build_color_lemantrend_frame, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — ColorLeManTrend\n' + '=' * 60)
    for key in [
