...
from strategy_hercules_atc_2006 import HerculesAtc2006Strategy, Mt5PandasFeed, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Hercules A.T.C. 2006\n' + '=' * 60)
    for key in [
        ...
        'total_trades', 'won', 'lost', 'win_rate', 'profit_factor', 'sharpe_ratio', 'annual_return_pct',
        'max_drawdown', 'sqn',
    ]:
        value = metrics[key]
