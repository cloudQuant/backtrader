...
from strategy_colortrend_cf import ColorTrendCfFeed, ColorTrendCfStrategy, Mt5PandasFeed, build_colortrend_cf_frame, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — ColorTrend_CF\n' + '=' * 60)
    for key in [
