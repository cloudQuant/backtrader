...
from strategy_macd_sample import MacdSampleStrategy, Mt5PandasFeed, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — MACD SAMPLE\n' + '=' * 60)
    for key in [
        'fromdate', 'todate', 'bars', 'bar_num', 'buy_signal_count', 'sell_signal_count',
        'close_long_signal_count', 'close_short_signal_count', 'completed_order_count',
        'rejected_order_count', 'buy_count', 'sell_count', 'trade_count', 'initial_cash',
