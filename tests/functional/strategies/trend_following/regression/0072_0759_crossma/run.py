...
from strategy_crossma import CrossMAStrategy, Mt5PandasFeed, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — CrossMA\n' + '=' * 60)
    for key in [
        'fromdate', 'todate', 'bars', 'bar_num', 'signal_count', 'buy_count', 'sell_count', 'trade_count',
        'completed_orders', 'rejected_orders', 'loss_streak', 'initial_cash', 'final_value', 'net_pnl',
