...
from strategy_propfirm_breakout import Mt5PandasFeed, PropFirmBreakoutStrategy, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60)
    print('BACKTEST RESULTS — Breakout Strategy with Prop Firm Helper')
    print('=' * 60)
    ...
    print(f"  Challenge closed:  {metrics['challenge_closed']}")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Breakout Strategy with Prop Firm Helper Backtest Runner')
