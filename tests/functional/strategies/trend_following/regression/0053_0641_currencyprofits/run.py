...
import yaml
from strategy_currencyprofits import Mt5PandasFeed, CurrencyProfitsStrategy, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(CurrencyProfitsStrategy, **config.get('params', {}))
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Currencyprofits\n' + '=' * 60)
