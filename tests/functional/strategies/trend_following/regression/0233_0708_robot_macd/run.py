...
from strategy_robot_macd import Mt5PandasFeed, RobotMACDStrategy, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(RobotMACDStrategy, **config.get('params', {}))
