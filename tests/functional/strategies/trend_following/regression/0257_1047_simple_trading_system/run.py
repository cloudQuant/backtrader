...
from strategy_simple_trading_system import (
    Mt5PandasFeed,
    SimpleTradingSystemFeed,
    SimpleTradingSystemStrategy,
    compute_simple_trading_system,
    load_mt5_csv,
    resample_frame,
)
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Exp_Simple_Trading_System\n' + '=' * 60)
