...
from strategy_bago_ea import BagoEaStrategy, Mt5PandasFeed, build_signal_frame, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Bago_EA\n' + '=' * 60)
    for key in [
        'bar_num', 'buy_count', 'sell_count', 'trade_count', 'initial_cash', 'final_value', 'net_pnl',
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Run Bago_EA backtest')
