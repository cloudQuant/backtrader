"""Inlined regression test for tests/functional/strategies/trend_following/regression/0163_1327_macd_cross.
...
_CONFIG = {
    'strategy': {
        'name': 'MACD Crossover',
        'source_ea': 'ea/1327_MQL5向导_-_基于MACD指标主线和信号线交叉的交易信�?expert_macd.mq5',
    },
    'data': {
        'symbol': 'XAUUSD',
        'timeframe': 'M15',
