...
def load_mt5_csv(filepath, fromdate=None, todate=None, bar_shift_minutes=0):
    """Load and normalize a quoted MT5-style CSV export into Backtrader-ready OHLCV data.

    Args:
        filepath: Absolute or relative path to the MT5 tab-separated text file.
        ...
        bar_shift_minutes: Optional minute offset added to every timestamp.

    Returns:
        pandas.DataFrame: Normalized bars with columns `datetime`, `open`, `high`, `low`,
        `close`, `volume`, `openinterest`, indexed by `datetime`.
    """
