"""Inlined regression test for tests/functional/strategies/trend_following/regression/0175_golden_cross.
...
_CONFIG = {
    'strategy': {
        ...
        'source_spec': 'research_papers_gold/strategy_specs/technical_indicators/0273_Golden_Cross_Strategy.md',
    },
    'data': {
        'symbol': 'XAUUSD',
        'timeframe': 'D1',
