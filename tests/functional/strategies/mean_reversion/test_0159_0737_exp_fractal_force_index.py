...
def load_mt5_csv(filepath, fromdate=None, todate=None, bar_shift_minutes=0):
    """Load a MetaTrader-style TSV export into a pandas DataFrame indexed by datetime.

    Args:
        filepath: Absolute path to the source CSV/TSV data file.
        fromdate: Optional inclusive start datetime filter.
        todate: Optional inclusive end datetime filter.
        bar_shift_minutes: Number of minutes to shift bar timestamps.

    Returns:
        A DataFrame containing normalized columns ``datetime, open, high, low,
        close, tick_volume, real_volume, openinterest`` with datetime index.
    """
