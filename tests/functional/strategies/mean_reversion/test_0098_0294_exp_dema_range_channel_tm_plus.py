"""Inlined regression test for tests/functional/strategies/mean_reversion/regression/0098_0294_exp_dema_range_channel_tm_plus.
...
_CONFIG = {
    'strategy': {
        'name': 'Exp DEMA Range Channel Tm Plus',
        'source_ea': 'ea/0294_Exp_DEMA_Range_Channel_Tm_Plus/exp_dema_range_channel_tm_plus.mq5',
    },
    'data': {
        'symbol': 'XAUUSD',
        'base_timeframe': 'M15',
...
def test_98_0098_0294_exp_dema_range_channel_tm_plus() -> None:
    """Migrated regression test (runonce=True only).

    Originally located at tests/functional/strategies_regression/mean_reversion/0098_0294_exp_dema_range_channel_tm_plus.
    """
    captured = {}
    ...
    _close(metrics.get('final_value'), 1002588.6000000002, tol=1.002589e+00, key='final_value')
    _close(metrics.get('initial_cash'), 1000000.0, tol=1.000000e+00, key='initial_cash')
    _close(metrics.get('max_drawdown'), 0.0396162263025865, tol=1.000000e-06, key='max_drawdown')
    _close(metrics.get('annual_return'), 0.7960753216050946, tol=1.000000e-06, key='annual_return')
    _close(metrics.get('return_rate'), 0.00258525534575808, tol=1.000000e-06, key='return_rate')
    _close(metrics.get('sharpe_ratio'), 17.290945989011853, tol=1.729095e-05, key='sharpe_ratio')
    _close(metrics.get('sqn'), 2.3788356738699807, tol=2.378836e-06, key='sqn')
