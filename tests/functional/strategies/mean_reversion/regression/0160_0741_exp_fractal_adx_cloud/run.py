...
from strategy_exp_fractal_adx_cloud import AdxCloudFeed, ExpFractalAdxCloudStrategy, Mt5PandasFeed, compute_adx_cloud, load_mt5_csv, resample_frame
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Exp_Fractal_ADX_Cloud\n' + '=' * 60)
    for key in [
