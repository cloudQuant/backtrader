...
from strategy_framacandle import FramaCandleStrategy, Mt5PandasFeed, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(FramaCandleStrategy, **params)
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Exp_FrAMACandle\n' + '=' * 60)
    for key in [
