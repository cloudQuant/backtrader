...
from strategy_the_rsi_engine import TheRSIEngineStrategy
...
def print_report(metrics):
    print('\n' + '=' * 60)
    print('BACKTEST RESULTS — The RSI Engine')
    print('=' * 60)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='The RSI Engine Backtest Runner')
