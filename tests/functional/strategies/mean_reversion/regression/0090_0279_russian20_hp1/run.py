...
from strategy_russian20_hp1 import Mt5PandasFeed, Russian20HP1Strategy, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(Russian20HP1Strategy, **config.get('params', {}))
...
def main():
    parser = argparse.ArgumentParser(description='Run Russian20-hp1 backtest')
