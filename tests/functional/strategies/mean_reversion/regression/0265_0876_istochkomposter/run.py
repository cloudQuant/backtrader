...
from strategy_istochkomposter import ExpIStochKomposterStrategy, Mt5PandasFeed, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(ExpIStochKomposterStrategy, **strategy_params)
...
def print_report(metrics):
    print('\n' + '=' * 60)
    print('BACKTEST RESULTS — iStochKomposter')
    print('=' * 60)
