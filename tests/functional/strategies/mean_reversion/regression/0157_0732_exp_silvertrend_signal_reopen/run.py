...
from strategy_exp_silvertrend_signal_reopen import ExpSilverTrendSignalReOpenStrategy, Mt5PandasFeed, SilverTrendFeed, compute_silvertrend_signal, load_mt5_csv, resample_frame
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Exp_SilverTrend_Signal_ReOpen\n' + '=' * 60)
    for key in [
        'fromdate', 'todate', 'bars_base', 'bars_silver', 'bar_num', 'signal_count', 'trade_count',
