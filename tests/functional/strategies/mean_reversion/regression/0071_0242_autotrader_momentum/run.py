...
from strategy_autotrader_momentum import Mt5PandasFeed, AutotraderMomentumStrategy, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(AutotraderMomentumStrategy, **config.get('params', {}))
...
def main():
    parser = argparse.ArgumentParser(description='Run Autotrader Momentum backtest')
