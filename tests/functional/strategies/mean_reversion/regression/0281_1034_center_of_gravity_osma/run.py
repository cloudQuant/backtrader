...
from strategy_center_of_gravity_osma import (
    CenterOfGravityOSMAFeed,
    CenterOfGravityOSMAStrategy,
    Mt5PandasFeed,
    compute_center_of_gravity_osma,
    load_mt5_csv,
    resample_frame,
)
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Exp_CenterOfGravityOSMA\n' + '=' * 60)
