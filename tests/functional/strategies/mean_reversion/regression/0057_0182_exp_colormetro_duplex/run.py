...
from strategy_exp_colormetro_duplex import ColorMetroFeed, ExpColorMetroDuplexStrategy, Mt5PandasFeed, build_color_metro_frame, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Exp_ColorMETRO_Duplex\n' + '=' * 60)
    for key in [
