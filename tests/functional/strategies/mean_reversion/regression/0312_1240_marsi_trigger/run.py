...
from strategy_marsi_trigger import MaRsiTriggerFeed, MaRsiTriggerStrategy, Mt5PandasFeed, build_marsi_trigger_frame, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — MaRsi-Trigger\n' + '=' * 60)
    for key in [
