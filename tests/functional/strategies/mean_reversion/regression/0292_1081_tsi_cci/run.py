...
from strategy_tsi_cci import Mt5PandasFeed, TsiCciFeed, TsiCciStrategy, compute_tsi_cci, load_mt5_csv, resample_frame
...
def load_backtest_frames(config):
    ...
    h4 = compute_tsi_cci(h4, xma_method=params['xma_method'], cci_period=params['cci_period'], cci_price=params['cci_price'], mom_period=params['mom_period'], xlength1=params['xlength1'], xlength2=params['xlength2'], xlength3=params['xlength3'], xphase=params['xphase'])
...
def build_cerebro(config, frame):
    ...
    feed_h4 = TsiCciFeed(dataname=frame['h4'][['open', 'high', 'low', 'close', 'volume', 'openinterest', 'ind', 'sign']], timeframe=bt.TimeFrame.Minutes, compression=240)
    cerebro.adddata(feed_m15, name='XAUUSD_M15')
    cerebro.adddata(feed_h4, name='XAUUSD_H4_TSI_CCI')
    cerebro.addstrategy(TsiCciStrategy, **config.get('params', {}))
