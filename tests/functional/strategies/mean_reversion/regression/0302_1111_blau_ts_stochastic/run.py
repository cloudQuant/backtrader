...
from strategy_blau_ts_stochastic import BlauTSStochasticStrategy, Mt5PandasFeed, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — BLAU TS STOCHASTIC\n' + '=' * 60)
    for key in [
        ...
        'open_position_size', 'open_position_price', 'max_drawdown', 'sqn',
    ]:
        value = metrics[key]
