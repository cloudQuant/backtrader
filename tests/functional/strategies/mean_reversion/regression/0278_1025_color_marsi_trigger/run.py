...
from strategy_color_marsi_trigger import (
    ColorMaRsiTriggerFeed,
    ColorMaRsiTriggerStrategy,
    Mt5PandasFeed,
    compute_color_marsi_trigger,
    load_mt5_csv,
    resample_frame,
)
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Exp_ColorMaRsi-Trigger\n' + '=' * 60)
