...
import yaml
from strategy_promart import Mt5PandasFeed, ProMartStrategy, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — ProMart\n' + '=' * 60)
    for key in [
        'fromdate', 'todate', 'bars', 'bar_num', 'buy_count', 'sell_count', 'trade_count',
        'win_count', 'loss_count', 'loss_streak', 'last_trade_direction', 'last_trade_was_loss',
