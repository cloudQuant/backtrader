...
from strategy_exp_wpr import ExpWprStrategy, Mt5PandasFeed, load_mt5_csv, resample_frame
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Exp_WPR\n' + '=' * 60)
    for key in [
        'fromdate', 'todate', 'bars_m15', 'bars_h4', 'bars', 'bar_num', 'trade_count',
