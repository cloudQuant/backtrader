...
from strategy_exp_blautvi_tm import ExpBlauTVITmStrategy, Mt5PandasFeed, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(ExpBlauTVITmStrategy, **params)
...
def main():
    parser = argparse.ArgumentParser(description='Run Exp BlauTVI Tm backtest')
