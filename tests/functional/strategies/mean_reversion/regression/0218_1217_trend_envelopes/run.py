...
from strategy_trend_envelopes import Mt5PandasFeed, TrendEnvelopesFeed, TrendEnvelopesStrategy, build_trend_envelopes_frame, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — TrendEnvelopes\n' + '=' * 60)
    for key in [
