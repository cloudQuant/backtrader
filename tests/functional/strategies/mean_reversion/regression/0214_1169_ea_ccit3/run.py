...
from strategy_ccit3 import Ccit3SignalFeed, EaCcit3Strategy, Mt5PandasFeed, build_signal_frame, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — EA_CCIT3\n' + '=' * 60)
    for key in [
        'fromdate', 'todate', 'bars', 'bar_num', 'signal_count', 'buy_count', 'sell_count', 'trade_count',
        'win_count', 'loss_count', 'initial_cash', 'final_cash', 'final_value', 'net_pnl', 'total_return_pct',
        'total_trades', 'won', 'lost', 'win_rate', 'profit_factor', 'sharpe_ratio',
        'annual_return_pct', 'open_position_size', 'open_position_price', 'max_drawdown', 'sqn',
    ]:
        value = metrics[key]
