...
from strategy_mfi_histogram import ExpMFIHistogramStrategy, Mt5PandasFeed, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(ExpMFIHistogramStrategy, **strategy_params)
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — MFI_Histogram\n' + '=' * 60)
    for key in [
