...
from strategy_gold_event_momentum_reversal import (
    GoldEventMomentumReversalFeed,
    GoldEventMomentumReversalStrategy,
    load_mt5_csv,
    prepare_gold_event_momentum_reversal_features,
)
...
def main():
    ...
    print(f"Loaded event reversal bars: {len(inputs['data'])}")
