...
from strategy_color_zerolag_trix_osma import (
    ColorZerolagTriXOSMAFeed,
    ColorZerolagTriXOSMAStrategy,
    Mt5PandasFeed,
    compute_color_zerolag_trix_osma,
    load_mt5_csv,
    resample_frame,
)
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Exp_ColorZerolagTriXOSMA\n' + '=' * 60)
