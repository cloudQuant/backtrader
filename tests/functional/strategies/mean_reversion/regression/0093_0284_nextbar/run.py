...
from strategy_nextbar import Mt5PandasFeed, NextbarStrategy, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(NextbarStrategy, **config.get('params', {}))
...
def main():
    parser = argparse.ArgumentParser(description='Run Nextbar backtest')
