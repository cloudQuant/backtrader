...
from strategy_dynamicrs_c import DynamicRsCFeed, DynamicRsCStrategy, Mt5PandasFeed, compute_dynamicrs_c, load_mt5_csv, resample_frame
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Exp_DynamicRS_C\n' + '=' * 60)
    for key in [
