...
from strategy_exp_finetuningmacandle_duplex import (
    ExpFineTuningMACandleDuplexStrategy,
    FineTuningFeed,
    build_signal_frame,
)
...
def print_report(metrics):
    print('\n' + '=' * 72)
    print('BACKTEST RESULTS — Exp_FineTuningMACandle_Duplex')
    print('=' * 72)
    for key in [
        'fromdate', 'todate', 'bars', 'bar_num', 'long_entries', 'short_entries',
        'trade_count', 'initial_cash', 'final_value', 'net_pnl', 'total_return_pct',
        'total_trades', 'won', 'lost', 'win_rate', 'profit_factor', 'sharpe_ratio',
