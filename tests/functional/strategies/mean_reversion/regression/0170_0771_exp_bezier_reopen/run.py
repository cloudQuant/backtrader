...
from strategy_exp_bezier_reopen import BezierFeed, ExpBezierReopenStrategy, Mt5PandasFeed, build_bezier_frame, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Exp_Bezier_ReOpen\n' + '=' * 60)
    for key in [
        'fromdate', 'todate', 'bars', 'bar_num', 'signal_count', 'trade_count',
        'win_count', 'loss_count', 'initial_cash', 'final_value', 'net_pnl', 'total_return_pct', 'total_trades',
        'won', 'lost', 'win_rate',
