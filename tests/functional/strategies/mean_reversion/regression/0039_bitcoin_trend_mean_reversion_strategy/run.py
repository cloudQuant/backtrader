...
from strategy_bitcoin_trend_mean_reversion import BitcoinTrendMeanReversionStrategy, load_mt5_csv, prepare_trend_mean_reversion_data
...
def resolve_data_path(filename):
    ...
    candidates = [
        ...
        (Path(__file__).resolve().parents[6] / 'tests' / 'datas' / 'mt5_1d_data' / basename).resolve(),
    ]
...
def print_results(metrics):
    ...
    print(f"  Trend/MR days:       {metrics['trend_days']}/{metrics['mean_reversion_days']}")
...
def main():
    ...
    print(f"Loaded bitcoin-trend-mean-reversion bars: {len(inputs['prepared'])}")
