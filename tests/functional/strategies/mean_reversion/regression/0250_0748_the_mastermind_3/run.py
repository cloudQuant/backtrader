...
from strategy_the_mastermind_3 import Mt5PandasFeed, TheMastermind3Strategy, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(TheMastermind3Strategy, **config.get('params', {}))
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — The MasterMind 3\n' + '=' * 60)
    for key in [
