...
from strategy_force_diversign import ForceDiverSignStrategy, Mt5PandasFeed, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Exp_Force_DiverSign\n' + '=' * 60)
    for key in [
