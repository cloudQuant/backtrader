...
from strategy_xcci_histogram_vol import Mt5PandasFeed, ExpXCCIHistogramVolStrategy, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(ExpXCCIHistogramVolStrategy, **config.get('params', {}))
