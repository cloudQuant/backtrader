...
from strategy_colorhma import ColorHMAStrategy, Mt5PandasFeed, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(ColorHMAStrategy, **config.get('params', {}))
