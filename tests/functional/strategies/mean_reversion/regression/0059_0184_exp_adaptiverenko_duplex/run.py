...
from strategy_exp_adaptiverenko_duplex import AdaptiveRenkoFeed, ExpAdaptiveRenkoDuplexStrategy, INDICATOR_ATR, Mt5PandasFeed, PRICE_CLOSE, build_adaptive_renko_frame, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Exp_AdaptiveRenko_Duplex\n' + '=' * 60)
    for key in [
