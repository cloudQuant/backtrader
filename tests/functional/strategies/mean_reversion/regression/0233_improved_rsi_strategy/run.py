...
from strategy_improved_rsi import ImprovedRSIStrategy, load_mt5_csv, prepare_improved_rsi_data
...
def print_results(metrics):
    ...
    print(f"  Avg improved RSI:    {metrics['avg_rsi']:.2f}")
...
def main():
    ...
    print(f"Loaded improved-rsi bars: {len(inputs['prepared'])}")
