...
from strategy_nrtr_revers import Mt5PandasFeed, NrtrReversStrategy, load_mt5_csv
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Run NRTR_Revers backtest')
