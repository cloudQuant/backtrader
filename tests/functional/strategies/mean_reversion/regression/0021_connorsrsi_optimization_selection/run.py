...
from strategy_connorsrsi_optimization_selection import ConnorsRSIOptimizationStrategy, Mt5ConnorsFeed, load_mt5_csv, prepare_connors_features
...
def load_backtest_frame(config):
    ...
    frame = prepare_connors_features(raw, params)
    if frame.empty:
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(ConnorsRSIOptimizationStrategy, **frame['params'])
...
def print_report(metrics):
    print('\n' + '=' * 60)
    print('BACKTEST RESULTS — ConnorsRSI Optimization Selection')
    print('=' * 60)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='ConnorsRSI Optimization Selection Runner')
