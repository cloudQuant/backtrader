...
from strategy_trendmanager_tm_plus import Mt5PandasFeed, ExpTrendManagerTmPlusStrategy, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(ExpTrendManagerTmPlusStrategy, **config.get('params', {}))
