...
from strategy_exp_trend_intensity_index import Mt5PandasFeed, ExpTrendIntensityIndexStrategy, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(ExpTrendIntensityIndexStrategy, **config.get('params', {}))
...
def main():
    parser = argparse.ArgumentParser(description='Run Exp_Trend_Intensity_Index backtest')
