...
import yaml
from strategy_20_pips_opposite_last_n_hour_trend import Mt5PandasFeed, OppositeLastNHourTrendStrategy, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — 20 Pips Opposite Last N Hour Trend\n' + '=' * 60)
