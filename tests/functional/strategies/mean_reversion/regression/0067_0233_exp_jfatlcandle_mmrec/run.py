...
from strategy_jfatlcandle_mmrec import Mt5PandasFeed, ExpJFatlCandleMMRecStrategy, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(ExpJFatlCandleMMRecStrategy, **config.get('params', {}))
