...
from strategy_colormetro_wpr import ColorMetroWprStrategy, Mt5PandasFeed, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(ColorMetroWprStrategy, **params)
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Exp_ColorMETRO_WPR\n' + '=' * 60)
    for key in [
