...
from strategy_sensitive import Mt5PandasFeed, SensitiveStrategy, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(SensitiveStrategy, **config.get('params', {}))
...
def main():
    parser = argparse.ArgumentParser(description='Run Sensitive backtest')
