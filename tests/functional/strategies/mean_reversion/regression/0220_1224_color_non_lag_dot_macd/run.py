...
from strategy_color_non_lag_dot_macd import ColorNonLagDotMacdFeed, ColorNonLagDotMacdStrategy, Mt5PandasFeed, build_colornonlagdotmacd_frame, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — ColorNonLagDotMACD\n' + '=' * 60)
    for key in [
