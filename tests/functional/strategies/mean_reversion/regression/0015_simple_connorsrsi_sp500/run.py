...
from strategy_simple_connorsrsi_sp500 import ConnorsRSIMeanReversionStrategy, Mt5ConnorsFeed, load_mt5_csv, prepare_connors_features
...
def print_report(metrics):
    ...
    print(f"  Expired orders:    {metrics['expired_count']}")
    print(f"  Rejected orders:   {metrics['rejected_count']}")
    print('-' * 60)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Simple ConnorsRSI SP500 Gold Adaptation Backtest Runner')
