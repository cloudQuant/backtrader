...
from strategy_stochastic_cg_oscillator import (
    Mt5PandasFeed,
    StochasticCGFeed,
    StochasticCGOscillatorStrategy,
    compute_stochastic_cg_oscillator,
    load_mt5_csv,
    resample_frame,
)
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Exp_StochasticCGOscillator\n' + '=' * 60)
    for key in [
