...
from strategy_55_ma import Mt5PandasFeed, FiftyFiveMAStrategy, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(FiftyFiveMAStrategy, **config.get('params', {}))
...
def main():
    parser = argparse.ArgumentParser(description='Run 55 MA backtest')
