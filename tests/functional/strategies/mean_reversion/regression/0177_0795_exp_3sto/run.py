...
from strategy_exp_3sto import Exp3StoStrategy, Mt5PandasFeed, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Exp_3STO\n' + '=' * 60)
    for key in [
        'fromdate', 'todate', 'bars', 'bar_num', 'trade_count',
        'initial_cash', 'final_value', 'net_pnl', 'total_return_pct', 'total_trades',
        'won', 'lost', 'win_rate', 'sharpe_ratio', 'annual_return_pct',
        'max_drawdown', 'sqn',
    ]:
        value = metrics[key]
