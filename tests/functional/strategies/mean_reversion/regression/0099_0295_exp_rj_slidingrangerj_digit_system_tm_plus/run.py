...
from strategy_exp_rj_slidingrangerj_digit_system_tm_plus import Mt5PandasFeed, ExpRjSlidingRangeSystemTmPlusStrategy, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(ExpRjSlidingRangeSystemTmPlusStrategy, **config.get('params', {}))
