...
from strategy_exp_fractal_mfi import ExpFractalMFIStrategy, FractalMfiFeed, Mt5PandasFeed, compute_fractal_mfi, load_mt5_csv, resample_frame
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Exp_Fractal_MFI\n' + '=' * 60)
    for key in [
        'fromdate', 'todate', 'bars_base', 'bars_fractal_mfi', 'bar_num', 'signal_count', 'trade_count',
