...
from strategy_dinapoli_stochastic import (
    DiNapoliStochasticFeed,
    DiNapoliStochasticStrategy,
    Mt5PandasFeed,
    compute_dinapoli_stochastic,
    load_mt5_csv,
    resample_frame,
)
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Exp_DiNapoliStochastic\n' + '=' * 60)
