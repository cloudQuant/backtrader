...
from strategy_color_tsi_oscillator import (
    ColorTsiOscillatorFeed,
    ColorTsiOscillatorStrategy,
    Mt5PandasFeed,
    compute_color_tsi_oscillator,
    load_mt5_csv,
    resample_frame,
)
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Exp_ColorTSI-Oscillator\n' + '=' * 60)
    for key in [
        'fromdate', 'todate', 'bars_m15', 'bars_h4', 'bar_num', 'buy_signals', 'sell_signals',
