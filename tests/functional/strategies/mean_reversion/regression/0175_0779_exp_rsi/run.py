...
from strategy_exp_rsi import ExpRsiStrategy, Mt5PandasFeed, load_mt5_csv, resample_frame
...
def build_cerebro(config, frame):
    ...
    cerebro.adddata(feed_h4, name='XAUUSD_H4_RSI')
    cerebro.addstrategy(ExpRsiStrategy, **config.get('params', {}))
