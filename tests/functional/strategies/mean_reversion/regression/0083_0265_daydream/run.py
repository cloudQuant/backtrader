...
from strategy_daydream import Mt5PandasFeed, DaydreamStrategy, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(DaydreamStrategy, **config.get('params', {}))
...
def main():
    parser = argparse.ArgumentParser(description='Run Daydream backtest')
