...
from strategy_exp_spearmanrankcorrelation_histogram import ExpSpearmanRankCorrelationHistogramStrategy, Mt5PandasFeed, load_mt5_csv, resample_ohlcv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Exp SpearmanRankCorrelation Histogram\n' + '=' * 60)
    for key in [
