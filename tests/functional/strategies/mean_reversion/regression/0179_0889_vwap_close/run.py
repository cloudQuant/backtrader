...
from strategy_vwap_close import ExpVWAPCloseStrategy, Mt5PandasFeed, load_mt5_csv
...
def print_report(m):
    print('\n'+'='*60+'\nBACKTEST RESULTS — VWAP_Close\n'+'='*60)
    for k in ['fromdate','todate','bars','bar_num','signal_count','trade_count',
              'initial_cash','final_value','net_pnl','total_return_pct','total_trades','won','lost',
              'win_rate','sharpe_ratio','annual_return_pct','max_drawdown','sqn']:
