...
from strategy_exp_finetuningmacandle import FineTuningMacandleStrategy, Mt5PandasFeed, build_signal_frame, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Exp_FineTuningMACandle\n' + '=' * 60)
    for key in [
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Run Exp_FineTuningMACandle backtest')
