...
from strategy_colormetro_stochastic import ColorMetroStochasticStrategy, Mt5PandasFeed, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Exp_ColorMETRO_Stochastic\n' + '=' * 60)
    for key in [
        'fromdate', 'todate', 'bars', 'bar_num', 'buy_signal_count', 'sell_signal_count',
        'completed_order_count', 'rejected_order_count', 'trade_count', 'win_count', 'loss_count',
