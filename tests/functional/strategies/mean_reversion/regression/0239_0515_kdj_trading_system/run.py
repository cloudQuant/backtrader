...
import yaml
from strategy_kdj_trading_system import KDJTradingSystemStrategy, Mt5PandasFeed, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    source_feed = Mt5PandasFeed(dataname=frame['data'].copy(), timeframe=bt.TimeFrame.Minutes, compression=15)
    h1_source = Mt5PandasFeed(dataname=frame['data'].copy(), timeframe=bt.TimeFrame.Minutes, compression=15)
    cerebro.adddata(source_feed, name=f"{data_cfg['symbol']}_M15")
    cerebro.resampledata(h1_source, timeframe=bt.TimeFrame.Minutes, compression=60, name=f"{data_cfg['symbol']}_H1")
    cerebro.addstrategy(KDJTradingSystemStrategy, **params)
