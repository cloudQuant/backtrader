...
from strategy_exp_dema_range_channel_tm_plus import Mt5PandasFeed, ExpDemaRangeChannelTmPlusStrategy, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(ExpDemaRangeChannelTmPlusStrategy, **config.get('params', {}))
