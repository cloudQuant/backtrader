...
from strategy_stochastic_three_periods import Mt5PandasFeed, ThreePeriodStochStrategy, load_mt5_csv, resample_frame
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Three Period Stochastic\n' + '=' * 60)
    for key in [
        'fromdate', 'todate', 'bars_base', 'bars_m5', 'bars_m15', 'bars_m30', 'bar_num', 'signal_count', 'buy_count',
        'sell_count', 'trade_count', 'completed_orders', 'rejected_orders', 'initial_cash', 'final_value', 'net_pnl',
        'total_return_pct', 'total_trades', 'won', 'lost', 'win_rate', 'profit_factor', 'sharpe_ratio',
