...
from strategy_exp_weight_oscillator import ExpWeightOscillatorStrategy, Mt5PandasFeed, WeightOscillatorFeed, compute_weight_oscillator, load_mt5_csv, resample_frame
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Exp_WeightOscillator\n' + '=' * 60)
    for key in [
        'fromdate', 'todate', 'bars_base', 'bars_weight_osc', 'bar_num', 'signal_count', 'trade_count',
