...
from strategy_cronex_mfi import (
    CronexMFIFeed,
    CronexMFIStrategy,
    Mt5PandasFeed,
    compute_cronex_mfi,
...
def build_cerebro(config, frame):
    ...
    feed_signal = CronexMFIFeed(dataname=sig, timeframe=bt.TimeFrame.Minutes, compression=signal_minutes)
    cerebro.adddata(feed_m15, name='XAUUSD_M15')
    cerebro.adddata(feed_signal, name='XAUUSD_H4_CRONEX_MFI')
    cerebro.addstrategy(CronexMFIStrategy, **config.get('params', {}))
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Exp_CronexMFI\n' + '=' * 60)
    for key in [
