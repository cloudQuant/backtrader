...
from strategy_exp_mfi import ExpMfiStrategy, Mt5PandasFeed, load_mt5_csv, resample_frame
...
def build_cerebro(config, frame):
    ...
    cerebro.adddata(feed_h4, name='XAUUSD_H4_MFI')
    cerebro.addstrategy(ExpMfiStrategy, **config.get('params', {}))
