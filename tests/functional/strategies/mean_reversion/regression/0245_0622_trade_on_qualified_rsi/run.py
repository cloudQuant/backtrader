...
import yaml
from strategy_qualified_rsi import Mt5PandasFeed, QualifiedRSIStrategy, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(QualifiedRSIStrategy, **config.get('params', {}))
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Qualified RSI\n' + '=' * 60)
