...
from cci_compat import ensure_safe_cci_indicator
from strategy_super_trend import SuperTrendStrategy, Mt5PandasFeed, load_mt5_csv

MINUTES_PER_TRADING_YEAR = 24 * 60 * 252

ensure_safe_cci_indicator()
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Exp_Super_Trend\n' + '=' * 60)
    for key in [
