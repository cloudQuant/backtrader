...
from strategy_3crows_rsi import Mt5PandasFeed, ThreeCrowsSoldiersRSIStrategy, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(ThreeCrowsSoldiersRSIStrategy, **config.get('params', {}))
...
def print_report(metrics):
    print('\n' + '=' * 60)
    print('BACKTEST RESULTS — 3 Crows/Soldiers + RSI')
    print('=' * 60)
