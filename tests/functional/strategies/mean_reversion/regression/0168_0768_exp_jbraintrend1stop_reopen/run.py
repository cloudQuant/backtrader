...
from strategy_exp_jbraintrend1stop_reopen import (
    ExpJBrainTrend1StopReopenStrategy,
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Exp_JBrainTrend1Stop_ReOpen\n' + '=' * 60)
    for key in [
        'fromdate', 'todate', 'bars_m15', 'bars_signal', 'bar_num', 'signal_count',
        'trade_count', 'completed_orders', 'rejected_orders', 'initial_cash', 'final_value', 'net_pnl',
        'total_return_pct', 'total_trades', 'won', 'lost', 'win_rate',
