...
from strategy_trend_catcher import Mt5PandasFeed, TrendCatcherStrategy, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Trend Catcher\n' + '=' * 60)
    for key in [
        'fromdate', 'todate', 'bars', 'bar_num', 'signal_count', 'trade_count',
        'completed_orders', 'rejected_orders', 'initial_cash', 'final_value', 'net_pnl',
