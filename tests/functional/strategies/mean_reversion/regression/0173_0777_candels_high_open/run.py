...
from strategy_candels_high_open import CandelsHighOpenStrategy, Mt5PandasFeed, load_mt5_csv
...
def print_report(m):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — CandelsHighOpen\n' + '=' * 60)
    for k in ['fromdate', 'todate', 'bars', 'bar_num', 'trade_count',
