...
from strategy_blau_tstochi import BlauTStochIStrategy, Mt5PandasFeed, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(BlauTStochIStrategy, **config.get('params', {}))
