...
class ExpDeltaWPRStrategy(bt.Strategy):
    ...
    def __init__(self):
        ...
        self.ind = DeltaWPR(self.signal_data, wpr_period1=self.p.wpr_period1, wpr_period2=self.p.wpr_period2, level=self.p.level)
        self.signal_count = 0
        self.trade_count = 0
        self.buy_count = 0
        self.sell_count = 0
    ...
    def next(self):
        ...
        if len(self.signal_data) < max(int(self.p.wpr_period1), int(self.p.wpr_period2)) + sb + 3: return
