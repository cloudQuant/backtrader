...
from strategy_rsi_rftl_ea import Mt5PandasFeed, RsiRftlEaStrategy, load_mt5_csv
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Run RSI_RFTL_EA backtest')
