...
from strategy_expbuysellside import ExpBuySellSideStrategy, Mt5PandasFeed, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — ExpBuySellSide\n' + '=' * 60)
    for key in [
        ...
        'total_trades', 'won', 'lost', 'win_rate', 'sharpe_ratio', 'annual_return_pct',
        'max_drawdown', 'sqn',
    ]:
        value = metrics[key]
