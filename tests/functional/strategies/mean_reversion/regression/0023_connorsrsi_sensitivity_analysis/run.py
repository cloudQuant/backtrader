...
from strategy_connorsrsi_sensitivity_analysis import ConnorsRSISensitivityStrategy, Mt5ConnorsFeed, load_mt5_csv, prepare_connors_features
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(ConnorsRSISensitivityStrategy, **frame['params'])
...
def print_report(metrics):
    print('\n' + '=' * 60)
    print('BACKTEST RESULTS — ConnorsRSI Sensitivity Analysis')
    print('=' * 60)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='ConnorsRSI Sensitivity Analysis Runner')
