...
from strategy_gaps import Mt5PandasFeed, GapsStrategy, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(GapsStrategy, **config.get('params', {}))
...
def main():
    parser = argparse.ArgumentParser(description='Run Gaps EA backtest')
