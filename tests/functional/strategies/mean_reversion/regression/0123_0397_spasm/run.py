...
from strategy_spasm import Mt5PandasFeed, SpasmStrategy, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(SpasmStrategy, **config.get('params', {}))
...
def main():
    parser = argparse.ArgumentParser(description='Run Spasm backtest')
