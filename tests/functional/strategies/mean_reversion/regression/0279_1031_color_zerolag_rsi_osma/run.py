...
from strategy_color_zerolag_rsi_osma import (
    ColorZerolagRSIOSMAFeed,
    ColorZerolagRSIOSMAStrategy,
    Mt5PandasFeed,
    compute_color_zerolag_rsi_osma,
    load_mt5_csv,
    resample_frame,
)
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Exp_ColorZerolagRSIOSMA\n' + '=' * 60)
