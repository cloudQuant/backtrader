...
from strategy_3crows_mfi import Mt5PandasFeed, ThreeCrowsSoldiersMFIStrategy, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(ThreeCrowsSoldiersMFIStrategy, **config.get('params', {}))
...
def print_report(metrics):
    print('\n' + '=' * 60)
    print(f"BACKTEST RESULTS — 3 Crows/Soldiers + MFI")
    print('=' * 60)
