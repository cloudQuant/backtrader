...
from strategy_gpftc_pivot_stop import GpfTcpivotStopStrategy, PivotStopFeed, build_pivot_frame, load_mt5_csv
...
def print_report(metrics):
    ...
    for key in [
        ...
        'win_count', 'loss_count', 'initial_cash', 'final_value', 'net_pnl', 'total_return_pct',
