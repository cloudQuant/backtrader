#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Gold Event Momentum Reversal 策略回测"""
...
from strategy_gold_event_momentum_reversal import (
    Mt5GoldEventMomentumReversalFeed, GoldEventMomentumReversalStrategy, load_mt5_csv, prepare_gold_event_momentum_reversal_features,
)
