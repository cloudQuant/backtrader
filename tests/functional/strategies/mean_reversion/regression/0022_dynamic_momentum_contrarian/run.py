...
from strategy_dynamic_momentum_contrarian import DynamicMomentumContrarianStrategy, Mt5DynamicFeed, load_mt5_csv, prepare_dynamic_features
...
def print_report(metrics):
    print('\n' + '=' * 60)
    print('BACKTEST RESULTS — Dynamic Momentum Contrarian')
    print('=' * 60)
    ...
    print(f"  Momentum mode days:    {metrics['momentum_mode_days']}")
    print(f"  Contrarian mode days:  {metrics['contrarian_mode_days']}")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Dynamic Momentum Contrarian Runner')
