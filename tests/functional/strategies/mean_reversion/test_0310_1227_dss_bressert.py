...
def load_mt5_csv(filepath, fromdate=None, todate=None, bar_shift_minutes=0):
    """Load MT5-style tab-separated CSV exported bars into a datetime-indexed DataFrame.

    Args:
        filepath: Path to the source file.
        fromdate: Optional lower bound datetime filter.
        todate: Optional upper bound datetime filter.
        bar_shift_minutes: Optional shift applied to the parsed bar timestamp.

    Returns:
        Filtered DataFrame with OHLCV columns ordered as ``datetime``,
