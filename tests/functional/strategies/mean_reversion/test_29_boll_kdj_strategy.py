...
def resolve_data_path(filename: str) -> Path:
    ...
    Search Paths (in order):
        ...
        2. Parent directory: BASE_DIR.parent.parent.parent / filename
        3. Grandparent directory: BASE_DIR.parent.parent.parent.parent / filename
        4. Tests data directory: BASE_DIR.parent.parent.parent.parent / "tests" / "datas" / filename
