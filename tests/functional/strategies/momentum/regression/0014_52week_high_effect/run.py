...
from strategy_52week_high_effect import High52WeekEffectStrategy, Mt5HighEffectFeed, load_mt5_csv, prepare_high_effect_features
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Run 52-Week High Effect backtest')
