...
from strategy_range_expansion_index import (
    Mt5PandasFeed,
    RangeExpansionIndexFeed,
    RangeExpansionIndexStrategy,
    compute_range_expansion_index,
    load_mt5_csv,
    resample_frame,
)
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Exp_RangeExpansionIndex\n' + '=' * 60)
    for key in [
