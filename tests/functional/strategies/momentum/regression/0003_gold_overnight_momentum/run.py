...
from strategy_gold_overnight_momentum import (
    GoldOvernightMomentumStrategy,
    Mt5OvernightMomentumFeed,
    load_mt5_csv,
    prepare_overnight_features,
)
...
def print_report(metrics):
    print('\n' + '=' * 60)
    print('BACKTEST RESULTS — Gold Overnight Momentum')
    print('=' * 60)
    ...
    print(f"  Daily exits:         {metrics['daily_exit_count']}")
    print(f"  Stop exits:          {metrics['stop_exit_count']}")
    print(f"  Take exits:          {metrics['take_exit_count']}")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Run Gold Overnight Momentum backtest.')
