...
from strategy_yesterday_today import Mt5PandasFeed, YesterdayTodayStrategy, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Yesterday Today\n' + '=' * 60)
    for key in [
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Run Yesterday Today backtest')
