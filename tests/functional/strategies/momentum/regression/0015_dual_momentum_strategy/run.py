...
from strategy_dual_momentum_strategy import DualMomentumStrategy, Mt5DualMomentumFeed, load_mt5_csv, prepare_dual_momentum_features
...
def print_report(metrics):
    print('\n' + '=' * 60)
    print('BACKTEST RESULTS — Dual Momentum Strategy')
    print('=' * 60)
    ...
    print(f"  Gold selected months: {metrics['gold_selected_months']}")
    print(f"  Cash months:          {metrics['cash_months']}")
    print(f"  Gold selected pct:    {metrics['gold_selected_pct']:.2f}%")
    print('=' * 60)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Dual Momentum Strategy Runner')
