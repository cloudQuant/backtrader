...
from strategy_gold_momentum import (
    Mt5MomentumFeed, GoldMomentumStrategy, load_mt5_csv, prepare_momentum_features,
)
...
def load_data(config):
    ...
    df = prepare_momentum_features(raw, config.get('params', {}))
...
def build_cerebro(frame, config):
    ...
    feed = Mt5MomentumFeed(dataname=frame['data'], timeframe=bt.TimeFrame.Days, compression=1)
