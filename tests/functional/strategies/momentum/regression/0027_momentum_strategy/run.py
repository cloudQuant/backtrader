...
from strategy_momentum import ASSET_NAMES, MomentumSignalFeed, MomentumStrategy, load_mt5_csv, prepare_momentum_data
...
def print_report(metrics):
    ...
    print(f"  Long months:         {metrics['long_months']}")
    print(f"  Short months:        {metrics['short_months']}")
