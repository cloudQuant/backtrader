...
from strategy_anchored_momentum import AnchoredMomentumFeed, AnchoredMomentumStrategy, Mt5PandasFeed, build_anchored_momentum_frame, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — AnchoredMomentum\n' + '=' * 60)
    for key in [
