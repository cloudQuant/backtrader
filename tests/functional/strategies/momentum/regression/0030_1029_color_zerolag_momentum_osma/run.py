...
from strategy_color_zerolag_momentum_osma import (
    ColorZerolagMomentumOSMAFeed,
    ColorZerolagMomentumOSMAStrategy,
    Mt5PandasFeed,
    compute_color_zerolag_momentum_osma,
    load_mt5_csv,
    resample_frame,
)
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Exp_ColorZerolagMomentumOSMA\n' + '=' * 60)
    for key in ['fromdate', 'todate', 'bars_m15', 'bars_h4', 'bar_num', 'buy_signal_count', 'sell_signal_count', 'buy_count', 'sell_count', 'trade_count', 'completed_order_count', 'rejected_order_count', 'initial_cash', 'final_value', 'net_pnl', 'total_return_pct', 'total_trades', 'won', 'lost', 'win_rate', 'profit_factor', 'sharpe_ratio', 'annual_return_pct', 'max_drawdown', 'sqn']:
        value = metrics[key]
