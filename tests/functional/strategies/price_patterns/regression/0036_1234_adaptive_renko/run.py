...
from strategy_adaptive_renko import AdaptiveRenkoFeed, AdaptiveRenkoStrategy, INDICATOR_ATR, Mt5PandasFeed, PRICE_CLOSE, build_adaptive_renko_frame, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — AdaptiveRenko\n' + '=' * 60)
    for key in [
