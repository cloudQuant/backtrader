...
from strategy_doji_trader import DojiTraderStrategy, Mt5PandasFeed, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(DojiTraderStrategy, **config.get('params', {}))
