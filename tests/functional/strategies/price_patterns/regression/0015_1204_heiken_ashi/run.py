...
import yaml
from strategy_heiken_ashi import Mt5PandasFeed, HeikenAshiStrategy, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(HeikenAshiStrategy, **config.get('params', {}))
