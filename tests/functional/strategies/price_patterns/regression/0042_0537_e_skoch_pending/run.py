...
import yaml
from strategy_e_skoch_pending import Mt5PandasFeed, ESkochPendingStrategy, load_mt5_csv, resample_ohlc
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — e-Skoch_Pending\n' + '=' * 60)
    for key in ['fromdate', 'todate', 'bars', 'bars_d1', 'bar_num', 'signal_count', 'buy_count', 'sell_count', 'trade_count',
