...
from strategy_darvasboxes_system import ExpDarvasBoxesSystemStrategy, Mt5PandasFeed, load_mt5_csv
...
def run(plot=False):
    ...
    cerebro.addstrategy(ExpDarvasBoxesSystemStrategy, **params)
    results = cerebro.run()
