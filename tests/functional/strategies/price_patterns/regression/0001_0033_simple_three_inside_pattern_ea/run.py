...
from strategy_simple_three_inside_pattern import Mt5PandasFeed, SimpleThreeInsidePatternStrategy, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60)
    print('BACKTEST RESULTS — Simple Three Inside Pattern EA')
    print('=' * 60)
    print(f"  Period:            {metrics['fromdate']} -> {metrics['todate']}")
    print(f"  Base bars:         {metrics['bars']}")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Simple Three Inside Pattern EA Backtest Runner')
