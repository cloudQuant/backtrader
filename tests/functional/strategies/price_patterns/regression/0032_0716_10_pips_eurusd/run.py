...
from strategy_10_pips_eurusd import Mt5PandasFeed, TenPipsEURUSDStrategy, load_mt5_csv, resample_daily
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS - 10 pips XAUUSD\n' + '=' * 60)
    for key in [
        'fromdate', 'todate', 'bars_base', 'bars_daily', 'bar_num', 'signal_count', 'buy_count', 'sell_count', 'trade_count', 'completed_orders', 'rejected_orders', 'initial_cash', 'final_value', 'net_pnl', 'total_return_pct', 'total_trades', 'won', 'lost', 'win_rate', 'profit_factor', 'sharpe_ratio', 'annual_return_pct', 'max_drawdown', 'sqn',
    ]:
        value = metrics[key]
