...
import yaml
from strategy_bullish_bearish_engulfing import Mt5PandasFeed, BullishBearishEngulfingStrategy, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Bullish and Bearish Engulfing\n' + '=' * 60)
