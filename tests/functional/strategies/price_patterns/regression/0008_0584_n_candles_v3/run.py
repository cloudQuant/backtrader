...
import yaml
from strategy_n_candles_v3 import Mt5PandasFeed, NCandlesV3Strategy, load_mt5_csv
...
def build_cerebro(config, frame):
    ...
    cerebro.addstrategy(NCandlesV3Strategy, **config.get('params', {}))
