...
import yaml
from strategy_hammer_mfi import Mt5PandasFeed, HammerMfiStrategy, load_mt5_csv
...
def print_report(m):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Hammer/Hanging Man + MFI\n' + '=' * 60)
    for k in ['fromdate', 'todate', 'bars', 'bar_num', 'buy_count', 'sell_count', 'trade_count', 'initial_cash', 'final_value', 'net_pnl', 'total_return_pct', 'total_trades', 'won', 'lost', 'win_rate', 'profit_factor', 'sharpe_ratio', 'annual_return_pct', 'max_drawdown', 'sqn']:
        v = m[k]
