...
from strategy_simple_price import Mt5PandasFeed, SimplePriceStrategy, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60)
    print('BACKTEST RESULTS — Simple Price')
    print('=' * 60)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Simple Price Backtest Runner')
