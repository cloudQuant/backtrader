...
def prepare_options_expiration_week_features(df, params):
    bullish_months = set(int(value) for value in params.get('bullish_months', [1, 2, 3, 4, 5, 9, 10, 11, 12]))
    bearish_months = set(int(value) for value in params.get('bearish_months', [6, 7, 8]))
    ...
    out = out[[
        ...
        'expiration_monday', 'expiration_friday', 'in_expiration_week',
        'month_bias', 'entry_signal', 'exit_signal', 'direction',
    ]].copy()
    return out.dropna()
...
class OptionsExpirationWeekFeed(bt.feeds.PandasData):
    ...
    params = (
        ...
        ('expiration_monday', 6), ('expiration_friday', 7), ('in_expiration_week', 8),
        ('month_bias', 9), ('entry_signal', 10), ('exit_signal', 11), ('direction', 12),
    )
...
class OptionsExpirationWeekStrategy(bt.Strategy):
    params = dict(
        ...
        take_profit=0.015,
        position_size=0.95,
        bullish_months=[1, 2, 3, 4, 5, 9, 10, 11, 12],
