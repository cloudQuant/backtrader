...
from strategy_simple_pending_orders_time import Mt5PandasFeed, SimplePendingOrdersTimeStrategy, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60)
    print('BACKTEST RESULTS — Simple Pending Orders Time')
    print('=' * 60)
    print(f"  Period:            {metrics['fromdate']} -> {metrics['todate']}")
    print(f"  Bars:              {metrics['bars']}")
    print(f"  Processed bars:    {metrics['bar_num']}")
    print(f"  Buy triggers:      {metrics['buy_count']}")
    print(f"  Sell triggers:     {metrics['sell_count']}")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Simple Pending Orders Time Backtest Runner')
