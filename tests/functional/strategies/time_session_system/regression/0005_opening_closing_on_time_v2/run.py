...
from strategy_opening_closing_on_time_v2 import Mt5PandasFeed, OpeningClosingOnTimeV2Strategy, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Opening and Closing on Time v2\n' + '=' * 60)
    for key in [
