...
from strategy_volatility_correlation_model import (
    ASSET_ORDER,
    VolCorrSignalFeed,
    VolatilityCorrelationModelStrategy,
    load_mt5_csv,
    prepare_vol_corr_inputs,
)
...
def write_local_result(config, metrics):
    ...
    with open(path, 'w', encoding='utf-8') as f:
        json.dump({k: normalize_value(v) for k, v in metrics.items()}, f, ensure_ascii=False, indent=2)
