...
from strategy_rock_trader_neuro import RockTraderNeuroStrategy, Mt5PandasFeed, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — ROCK TRADER NEURO\n' + '=' * 60)
    for key in [
        ...
        'annual_return_pct', 'open_position_size', 'open_position_price', 'last_out_value', 'max_drawdown', 'sqn',
    ]:
        value = metrics[key]
