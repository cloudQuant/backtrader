...
from strategy_adaptive_cyber_cycle import (
    AdaptiveCyberCycleStrategy,
    AdaptiveIndicatorFeed,
    Mt5PandasFeed,
    build_adaptive_signal_frame,
    load_mt5_csv,
)
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Adaptive Cyber Cycle\n' + '=' * 60)
    for key in [
