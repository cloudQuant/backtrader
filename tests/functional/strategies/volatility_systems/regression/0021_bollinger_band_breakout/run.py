...
from strategy_bollinger_breakout import (
    Mt5BollingerFeed, BollingerBreakoutStrategy, load_mt5_csv, prepare_bollinger_features,
)
...
def build_cerebro(frame, config):
    ...
    cerebro.addstrategy(BollingerBreakoutStrategy, **config.get('params', {}))
