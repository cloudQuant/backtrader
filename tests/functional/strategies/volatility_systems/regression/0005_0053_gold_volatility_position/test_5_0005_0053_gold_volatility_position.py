"""Inlined regression test for tests/functional/strategies/volatility_systems/regression/0005_0053_gold_volatility_position.
...
_CONFIG = {
    'strategy': {
        'id': '0053',
        'name': 'Gold Volatility Position Sizing',
        'source_spec': 'research_papers_gold/strategy_specs/volatility_regime/0053_Gold_Volatility_Position.md',
    },
    'data': {
        'symbol': 'XAUUSD',
        'timeframe': 'D1',
