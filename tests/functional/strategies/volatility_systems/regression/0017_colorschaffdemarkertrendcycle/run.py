...
from strategy_colorschaffdemarkertrendcycle import ColorSchaffDeMarkerTrendCycleStrategy, Mt5PandasFeed, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Exp_ColorSchaffDeMarkerTrendCycle\n' + '=' * 60)
    for key in [
