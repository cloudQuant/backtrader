...
from strategy_high_frequency_volatility_trader import (
    HighFrequencyVolatilityTraderStrategy,
    VolatilityHftFeed,
    build_signal_frame,
)
...
def print_report(metrics):
    print('\n' + '=' * 72)
    print('BACKTEST RESULTS — High frequency volatility trader')
    print('=' * 72)
    for key in [
        'fromdate', 'todate', 'bars', 'bar_num', 'buy_count', 'trade_count',
