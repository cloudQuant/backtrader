...
def load_mt5_csv(filepath, fromdate=None, todate=None, bar_shift_minutes=0):
    """Load MT5 tabular export data into a Backtrader-ready DataFrame.
    ...
    Returns:
        Parsed DataFrame indexed by datetime and including OHLCV columns.
    """
