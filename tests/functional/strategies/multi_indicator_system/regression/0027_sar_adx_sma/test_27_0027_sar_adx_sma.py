"""Inlined regression test for tests/functional/strategies/multi_indicator_system/regression/0027_sar_adx_sma.
...
_CONFIG = {
    'strategy': {
        'name': 'SAR + ADX + SMA100',
        'source_ea': 'ea/1109_基于指标_SAR_e_ADX_e_sma_100_的_EA',
    },
    'data': {
        'symbol': 'XAUUSD',
        'timeframe': 'M15',
