...
from strategy_ict_concepts_ea import ICTConceptsEAStrategy, Mt5PandasFeed, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 72 + '\nBACKTEST RESULTS — ICT Concepts EA\n' + '=' * 72)
    for key in [
    ...
    print('  debug_counts         :')
    for key, value in metrics['debug_counts'].items():
