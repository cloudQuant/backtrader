...
from strategy_raymond_cloudy_day import RaymondCloudyDayStrategy, RaymondPandasFeed, load_mt5_csv_with_raymond_levels
...
def print_report(metrics):
    print('\n' + '=' * 60)
    print('BACKTEST RESULTS — Raymond Cloudy Day For EA')
    print('=' * 60)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Raymond Cloudy Day Backtest Runner')
