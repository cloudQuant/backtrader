...
from strategy_indices_tester import IndicesTesterStrategy, Mt5PandasFeed, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60)
    print('BACKTEST RESULTS — Indices Tester')
    print('=' * 60)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Indices Tester Backtest Runner')
