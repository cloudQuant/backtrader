...
import yaml
from strategy_billy_trading_system import BillyTradingSystemStrategy, Mt5PandasFeed, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Billy 交易系统\n' + '=' * 60)
    for key in ['fromdate', 'todate', 'bars', 'bar_num', 'signal_count', 'buy_count', 'sell_count', 'trade_count',
