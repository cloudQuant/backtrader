...
from strategy_well_martin import Mt5PandasFeed, WellMartinStrategy, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — Well_Martin\n' + '=' * 60)
    for key in ['fromdate', 'todate', 'bars_m15', 'bar_num', 'buy_count', 'sell_count', 'trade_count', 'completed_order_count', 'rejected_order_count', 'initial_cash', 'final_value', 'net_pnl', 'total_return_pct', 'total_trades', 'won', 'lost', 'win_rate', 'profit_factor', 'sharpe_ratio', 'annual_return_pct', 'max_drawdown', 'sqn']:
        value = metrics[key]
