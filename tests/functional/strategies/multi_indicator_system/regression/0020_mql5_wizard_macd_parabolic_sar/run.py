...
from strategy_mql5_wizard_macd_parabolic_sar import MQL5WizardMacdParabolicSarStrategy, Mt5PandasFeed, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — MQL5 Wizard MACD Parabolic SAR\n' + '=' * 60)
    for key in [
