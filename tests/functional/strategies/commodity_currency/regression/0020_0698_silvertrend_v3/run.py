...
from strategy_silvertrend_v3 import Mt5PandasFeed, SilverTrendV3Strategy, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60 + '\nBACKTEST RESULTS — SilverTrend_v3\n' + '=' * 60)
    for key in [
        'fromdate', 'todate', 'bars_base', 'bar_num', 'signal_count', 'buy_count', 'sell_count',
