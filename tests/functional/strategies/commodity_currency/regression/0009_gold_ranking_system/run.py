...
from strategy_gold_ranking_system import (
    GoldRankingSignalFeed,
    GoldRankingSystemStrategy,
    load_mt5_csv,
    prepare_ranking_frames,
)
...
def main():
    ...
    print(f"Loaded ranking bars: {len(inputs['signal_df'])}")
