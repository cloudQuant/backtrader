...
from strategy_gold_commodity_trend import (
    GoldCommodityTrendFeed,
    GoldCommodityTrendStrategy,
    load_mt5_csv,
    prepare_gold_commodity_trend_features,
)
...
def main():
    ...
    print(f"Loaded commodity trend bars: {len(inputs['data'])}")
