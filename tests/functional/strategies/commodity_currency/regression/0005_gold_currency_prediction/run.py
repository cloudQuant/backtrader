...
from strategy_gold_currency_prediction import (
    GoldCurrencyPredictionFeed,
    GoldCurrencyPredictionStrategy,
    load_mt5_csv,
    prepare_currency_prediction_data,
)
...
def upsert_global_summary(config, metrics):
    ...
    rows.append({
        ...
        'symbol': 'XAUUSD/DXYN/EURUSD/USDJPY',
...
def main():
    ...
    print(f"Loaded prediction bars: {len(inputs['data'])}")
