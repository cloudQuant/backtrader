...
from strategy_fx_regression_learning import FXRegressionFeed, FXRegressionLearningStrategy, load_mt5_csv, prepare_regression_features
...
def main():
    ...
    print(f"Loaded FX regression bars: {len(inputs['data'])}")
