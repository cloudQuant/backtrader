...
from strategy_gold_factor_timing import (
    GoldFactorTimingSignalFeed,
    GoldFactorTimingStrategy,
    load_mt5_csv,
    prepare_factor_timing_data,
)
...
def print_report(metrics):
    print('\n' + '=' * 60)
    print('BACKTEST RESULTS — Gold Factor Timing')
    print('=' * 60)
    ...
    print(f"  Value months:        {metrics['value_month_count']}")
    print(f"  Momentum months:     {metrics['momentum_month_count']}")
    print(f"  Both-factor months:  {metrics['both_month_count']}")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Run Gold Factor Timing backtest.')
