...
from strategy_gold_real_rate_signal import (
    GoldRealRateSignalFeed,
    GoldRealRateSignalStrategy,
    load_mt5_csv,
    prepare_real_rate_signal_features,
)
...
def main():
    ...
    print(f"Loaded real rate signal bars: {len(inputs['data'])}")
