...
from strategy_ka_gold_bot import KAGoldBotStrategy, Mt5PandasFeed, load_mt5_csv
...
def print_report(metrics):
    print('\n' + '=' * 60)
    print('BACKTEST RESULTS — KA Gold Bot MT5')
    print('=' * 60)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='KA Gold Bot MT5 Backtest Runner')
