...
from strategy_gold_quantpedia_strategies import (
    GoldQuantpediaFeed,
    GoldQuantpediaStrategy,
    load_mt5_csv,
    prepare_gold_quantpedia_features,
)
...
def main():
    ...
    print(f"Loaded Quantpedia collection bars: {len(inputs['data'])}")
