...
from strategy_short_term_overbought_downtrend import ShortTermOverboughtInDowntrendStrategy, load_mt5_csv, prepare_overbought_data
...
def print_results(metrics):
    ...
    print(f"  Downtrend/Signals:   {metrics['downtrend_days']}/{metrics['signal_days']}")
