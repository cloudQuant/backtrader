...
from strategy_cbi_bullish_signal import (
    CBIBullishSignalStrategy,
    Mt5CBIBullishFeed,
    load_mt5_csv,
    prepare_cbi_bullish_features,
)
...
def print_results(metrics):
    ...
    print(f"  Stop exits:        {metrics['stop_loss_exit_count']}")
    print(f"  TP exits:          {metrics['take_profit_exit_count']}")
