...
def resolve_data_path(filename: str) -> Path:
    ...
    Search Paths (in order):
        ...
        2. BASE_DIR.parent.parent.parent / filename (parent directory)
        3. BASE_DIR.parent.parent.parent.parent / filename (grandparent directory)
        4. BASE_DIR.parent.parent.parent.parent / "tests" / "datas" / filename
