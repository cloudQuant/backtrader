"""MACD EMA 多合约期货策略测试用例

使用螺纹钢期货多合约数据测试 MACD + EMA 趋势策略
- 使用 PandasDirectData 加载多个合约数据
- MACD 金叉/死叉信号 + 移仓换月逻辑
"""
