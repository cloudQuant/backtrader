...
def test_etf_rotation_strategy():
    ...
    # 断言测试结果（精确值）
    assert strat.bar_num == 2638, f"Expected bar_num=2638, got {strat.bar_num}"
    ...
    assert sharpe_ratio == 0.5429576897026931, f"Expected sharpe_ratio=0.5429576897026931, got {sharpe_ratio}"
    assert annual_return == 0.15938920375171883, f"Expected annual_return=0.15938920375171883, got {annual_return}"
