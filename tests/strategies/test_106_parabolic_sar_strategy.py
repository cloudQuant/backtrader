...
# -*- coding: utf-8 -*-
"""
测试用例: Parabolic SAR 抛物线指标策略

参考来源: strategies_backtrader/SAR (STOP AND REVERSE) METHOD.ipynb
使用SAR指标判断趋势反转
"""
...
def test_parabolic_sar_strategy():
    ...
    print("=" * 50)
    print("Parabolic SAR 抛物线指标策略回测结果:")
