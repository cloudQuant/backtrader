...
def _make_event(data, channel_type, channel_name='BTC/USDT', ts=100.0):
    """Create a test event for LiveDataValidator tests.

    Args:
        data: The event data (TickEvent, OrderBookSnapshot, etc.).
        channel_type: Type of channel ('tick', 'orderbook', 'funding').
        channel_name: Name of the channel/symbol.
        ts: Timestamp for the event.

    Returns:
        Event: A configured Event instance for testing.
    """
...
class TestRateLimiter(unittest.TestCase):
    ...
    def setUp(self):
        """Set up test fixtures by importing RateLimiter."""
...
class TestRetryWithBackoff(unittest.TestCase):
    ...
    def setUp(self):
        """Set up test fixtures by importing retry_with_backoff."""
...
class TestExchangeConfig(unittest.TestCase):
    ...
    def setUp(self):
        """Set up test fixtures by importing ExchangeConfig."""
...
class TestThreadedDataManager(unittest.TestCase):
    ...
    def setUp(self):
        """Set up test fixtures by importing ThreadedDataManager."""
...
class TestThreadedOrderManager(unittest.TestCase):
    ...
    def setUp(self):
        """Set up test fixtures by importing ThreadedOrderManager."""
...
class TestConnectionManager(unittest.TestCase):
    ...
    def setUp(self):
        """Set up test fixtures by importing ConnectionManager."""
...
class TestBracketOrder(unittest.TestCase):
    ...
    def setUp(self):
        """Set up test fixtures by importing BracketOrder classes."""
...
class TestBracketOrderManager(unittest.TestCase):
    ...
    def setUp(self):
        """Set up test fixtures by importing BracketOrderManager."""
