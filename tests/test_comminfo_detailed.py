...
def test_broker_integration():
    ...
    class TestStrategy(bt.Strategy):
        ...
        def start(self):
            ...
            print(f"  Broker CommInfo commission: {broker_comminfo.get_param('commission') if hasattr(broker_comminfo, 'get_param') else getattr(broker_comminfo, 'p', {}).commission}")
            print(f"  Broker CommInfo margin: {broker_comminfo.get_param('margin') if hasattr(broker_comminfo, 'get_param') else getattr(broker_comminfo, 'p', {}).margin}")
            print(f"  Broker CommInfo stocklike: {broker_comminfo.get_param('stocklike') if hasattr(broker_comminfo, 'get_param') else getattr(broker_comminfo, 'p', {}).stocklike}")
