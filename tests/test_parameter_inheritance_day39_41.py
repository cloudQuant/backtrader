...
from backtrader.parameters import (
    ...
    Int, Float, OneOf, String, ParameterValidationError
)
...
class TestMultiLevelInheritance:
    ...
    def test_two_level_inheritance(self):
        ...
        class GrandparentClass(ParameterizedBase):
            grandparent_param = ParameterDescriptor(default=1, type_=int, doc="Grandparent parameter")
            shared_param = ParameterDescriptor(default="grandparent", type_=str, doc="Shared parameter")
        
        class ParentClass(GrandparentClass):
            parent_param = ParameterDescriptor(default=2, type_=int, doc="Parent parameter")
            shared_param = ParameterDescriptor(default="parent", type_=str, doc="Parent overrides shared")
    ...
    def test_diamond_inheritance(self):
        ...
        expected_params = {'base_param', 'left_param', 'right_param', 'diamond_param', 'shared_param'}
        assert all_params == expected_params
...
class TestParameterOverrides:
    ...
    def test_documentation_inheritance(self):
        ...
        class ChildClass(BaseClass):
            documented_param = ParameterDescriptor(
                default="child",
                doc="Child documentation overrides base"
            )
