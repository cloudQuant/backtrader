...
def test_engineering_observation_runs_actual_highfreq_strategy_on_real_native_chain(
    ...
    assert report["session_binding"] == {
        ...
        "requested_environment_profile": "simnow_second_7x24",
        "environment_family": "set2",
        "market_alignment": "engineering_only",
        "attempted_profile": "set2_7x24_4000x",
        "actual_environment_profile": "set2_7x24_shadow",
        "selection_readiness": "not_probed",
        "selection_reason": "offline_frozen_selection",
        "clock_domain_id": "iter30-set2_7x24_4000x-monotonic-v1",
        "mapping_source": "iter30-set2_7x24_4000x-launcher-anchor",
        "profile_family_prefix": "set2",
