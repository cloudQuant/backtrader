...
FAILED tests/strategies/test_104_cci_strategy.py::test_cci_strategy - AssertionError: Expected final_value=100196.64, got 100142.57304001998
...
3. 很可能是 cci 指标实现的问题，参考 macd.py 指标实现的方式，实现这个指标。
