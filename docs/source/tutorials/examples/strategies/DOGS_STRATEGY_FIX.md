...
cerebro.addstrategy(
    ...
    period=40,              # 缩短周期（从 60 改为 40）
    devfactor=1.5,          # 缩窄带宽（从 2.0 改为 1.5）
    atr_mult=1.5,           # 缩紧止损（从 2.0 改为 1.5）
...
cerebro.addstrategy(
    BollingerBandsStrategy,
    period=80,              # 延长周期（从 60 改为 80）
    devfactor=2.5,          # 扩大带宽（从 2.0 改为 2.5）
    atr_mult=2.5,           # 放宽止损（从 2.0 改为 2.5）
