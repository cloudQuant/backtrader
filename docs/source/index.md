...
| [快速开始](user_guide/quickstart.md) | 5 分钟教程 | 新用户 |
...
2. **按对象类型处理初始化**- 直接 `bt.Strategy` 的 `self.p/data` 已提前建立；
   自定义父类/mixin 和其他组件按各自 cooperative 生命周期处理

1. **永远不要使用宽泛的异常捕获**
2. **代码注释使用英文**- Google 风格文档字符串
