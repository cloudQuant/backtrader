...
def demo_optimization_summary():
    ...
    optimizations = [
        ...
        {"name": "方法缓存优化", "improvement": "40-70%", "technique": "LRU缓存 + TTL过期"},
        {"name": "内存使用优化", "improvement": "20-40%", "technique": "__slots__ + 弱引用"},
        {"name": "线程安全优化", "improvement": "30-50%", "technique": "读写锁 + 无锁快速路径"},
    ]
